...
**此项目是 [awesome-go](https://awesome-go.com/) 中文版，最后一次同步时间 : 2019-07-03 09:23:09(每隔1天同步一次)**
...
* [algorithms](https://github.com/shady831213/algorithms) - **Star : 228** 算法和数据结构。来源于CLRS。![star > 100][Bronze]
* [binpacker](https://github.com/zhuangsirui/binpacker) - **Star : 120** 帮助用户构建自定义二进制流的二进制封装器和解包器![star > 100][Bronze]![最近一年没有更新][Yellow]
...
* [cuckoofilter](https://github.com/seiflotfy/cuckoofilter) - **Star : 493** 布谷鸟过滤器:一个用Go实现，可替代计数 bloom 过滤器。![star > 100][Bronze]
...
* [go-datastructures](https://github.com/Workiva/go-datastructures) - **Star : 5040** 可靠的、高性能的和线程安全的数据结构的集合。![star > 5000][Gold]
...
* [golang-set](https://github.com/deckarep/golang-set) - **Star : 1117** 线程安全和非线程安全的高性能集。![star > 1000][Silver]
...
* [willf/bloom](https://github.com/willf/bloom) - **Star : 646** 实现Bloom过滤器。![star > 100][Bronze]
...
* [bolt](https://github.com/boltdb/bolt) - **Star : 9859** K/V 数据库。![star > 5000][Gold]![最近一年没有更新][Yellow]
* [buntdb](https://github.com/tidwall/buntdb) - **Star : 2417** 基于内存的K/V，快速，可嵌入的数据库，可自定义索引和空间支持。![star > 1000][Silver]
...
* [eliasdb](https://github.com/krotik/eliasdb) - **Star : 531** 无其他依赖项，支持REST API，短语搜索和sql类似的查询语言的事务图数据库。![star > 100][Bronze]
...
* [gorocksdb](https://github.com/kapitan-k/gorocksdb) - **Star : 7** 用 Go 对[RocksDB](https://rocksdb.org)实现了封装。![最近一年没有更新][Yellow]
* [groupcache](https://github.com/golang/groupcache) - **Star : 7538** Groupcache是一个缓存和缓存填充库，在许多情况下，它是memcached的替代品。![star > 5000][Gold]
...
* [go-pg-migrations](https://github.com/robinjoseph08/go-pg-migrations) - **Star : 24** 用Go -pg/pg编写的迁移包。
...
* [pgweb](https://github.com/sosedoff/pgweb) - **Star : 5936** 基于web的PostgreSQL数据库浏览器。![star > 5000][Gold]
...
* [sqrl](https://github.com/elgris/sqrl) - **Star : 172** SQL查询生成器，从Squirrel fork而来，并再此基础上对性能做了优化。![star > 100][Bronze]
...
* NoSQL Databases
    ...
    * [redeo](https://github.com/bsm/redeo) - **Star : 257** 与 redis 协议兼容的 TCP 服务器/服务。![star > 100][Bronze]
...
* Search and Analytic Databases.
    ...
    * [elasticsql](https://github.com/cch123/elasticsql) - **Star : 367** 将 SQL 转换为 elasticsearch dsl。![star > 100][Bronze]
...
* [carbon](https://github.com/uniplaces/carbon) - **Star : 330** 简单的时间扩展，包含了许多使用方法，从 PHP Carbon 库移植的。![star > 100][Bronze]
...
* [glow](https://github.com/chrislusf/glow) - **Star : 2492** 全部用 Go 实现，易用、可伸缩，可用于分布式大数据处理，Map-Reduce, DAG执行。![star > 1000][Silver]
...
* [ringpop-go](https://github.com/uber/ringpop-go) - **Star : 563** 可伸缩的，容错、应用分层的的Go应用程序。![star > 100][Bronze]
...
* [go-duktape](https://github.com/olebedev/go-duktape) - **Star : 647** 支持 Duktape JavaScript 引擎。![star > 100][Bronze]
...
* [accounting](https://github.com/leekchan/accounting) - **Star : 476** 货币和货币格式。![star > 100][Bronze]
...
* [binding](https://github.com/mholt/binding) - **Star : 752** 将来自 net/HTTP 请求的表单、JSON 数据绑定到结构体。![star > 100][Bronze]![最近一年没有更新][Yellow]
...
* [fpGo](https://github.com/TeaEntityLab/fpGo) - **Star : 99** 提供函数式编程功能。
* [fuego](https://github.com/seborama/fuego) - **Star : 34** Functional Experiment in Go。
* [go-underscore](https://github.com/tobyhede/go-underscore) - **Star : 1058** 常用辅助方法集合。![star > 1000][Silver]
...
* [go-astar](https://github.com/beefsack/go-astar) - **Star : 322** 实现了A\*路径查找算法。![star > 100][Bronze]![最近一年没有更新][Yellow]
...
* [Leaf](https://github.com/name5566/leaf) - **Star : 2989** 轻量级游戏服务器框架。![star > 1000][Silver]
...
* [gen](https://github.com/clipperhouse/gen) - **Star : 1016** 用于生成泛型等类似方法的功能代码生成工具。![star > 1000][Silver]![最近一年没有更新][Yellow]
...
* [goderive](https://github.com/awalterschulze/goderive) - **Star : 717** 从输入类型来派生函数。![star > 100][Bronze]
...
* [osm](https://github.com/paulmach/osm) - **Star : 58** 用于读取、写入和处理 OpenStreetMap 数据和 APIs。
...
* [tardisgo](https://github.com/tardisgo/tardisgo) - **Star : 391** Golang 转换为 Haxe，再转换为 CPP/CSharp/Java/JavaScript 的编译器.![star > 100][Bronze]![最近一年没有更新][Yellow]
...
* [grpool](https://github.com/ivpusic/grpool) - **Star : 487** 轻量级协程池。![star > 100][Bronze]
...
* [tunny](https://github.com/Jeffail/tunny) - **Star : 1293** golang 的协程池。![star > 1000][Silver]
...
* [ui](https://github.com/andlabs/ui) - **Star : 6821** 跨平台的 Platform-native GUI 库。![star > 5000][Gold]
...
* [bimg](https://github.com/h2non/bimg) - **Star : 767** 使用libvips实现的快速高效的图像处理包。![star > 100][Bronze]
...
* [go-nude](https://github.com/koyachi/go-nude) - **Star : 279** Go语言实现的裸照检测工具。![star > 100][Bronze]
...
* [ln](https://github.com/fogleman/ln) - **Star : 2439** Go实现的3D线艺术（3D Line Art）渲染。![star > 1000][Silver]![最近一年没有更新][Yellow]
...
* [pt](https://github.com/fogleman/pt) - **Star : 1750** Go实现的路径跟踪（path tracing）引擎。![star > 1000][Silver]
...
* [rez](https://github.com/bamiaux/rez) - **Star : 181** 纯Go语言和SIMD实现的图像大小调整。![star > 100][Bronze]![最近一年没有更新][Yellow]
...
* [JobRunner](https://github.com/bamzi/jobrunner) - **Star : 559** 智能和功能丰富的cron作业调度程序（包含任务队列和实时监控）。![star > 100][Bronze]![最近一年没有更新][Yellow]
...
* [ocrserver](https://github.com/otiai10/ocrserver) - **Star : 216** 一个简单的OCR API服务器，非常容易被Docker和Heroku部署。![star > 100][Bronze]
...
* [go-nsq](https://github.com/nsqio/go-nsq) - **Star : 1435** NSQ的官方Go包。![star > 1000][Silver]
...
* [go-sample](https://github.com/zitryss/go-sample) - **Star : 17** 使用实际代码的Go应用程序项目的示例布局。
...
* [gojieba](https://github.com/yanyiwu/gojieba) - **Star : 788** 这是一个Go实现的[jieba](https://github.com/fxsjy/jieba)，这是一个中文分词算法。![star > 100][Bronze]
...
* [prose](https://github.com/jdkato/prose) - **Star : 2018** 用于支持标记化、词性标记、名称实体提取等文本处理的库。![star > 1000][Silver]
...
* [cidranger](https://github.com/yl2chen/cidranger) - **Star : 376** 快速IP到CIDR查找 Go 。![star > 100][Bronze]
* [dhcp6](https://github.com/mdlayher/dhcp6) - **Star : 60** 包dhcp6实现了一个DHCPv6服务器，如RFC 3315所述。
...
* [go-stun](https://github.com/ccding/go-stun) - **Star : 321** Go实现了STUN客户机(RFC 3489和RFC 5389)。![star > 100][Bronze]
...
* [gopcap](https://github.com/akrennmair/gopcap) - **Star : 347**  Go 包装libpcap。![star > 100][Bronze]![最近一年没有更新][Yellow]
...
* [go-queryset](https://github.com/jirfag/go-queryset) - **Star : 443** 100%类型安全ORM与代码生成和MySQL, PostgreSQL, Sqlite3, SQL Server支持基于GORM。![star > 100][Bronze]
...
* [upper.io/db](https://github.com/upper/db) - **Star : 1814** 通过使用封装成熟数据库驱动程序的适配器与不同数据源交互的单一接口。![star > 1000][Silver]
...
* [gom](https://github.com/mattn/gom) - **Star : 1353** Go Manager - bundle for Go。![star > 1000][Silver]![最近一年没有更新][Yellow]
...
* [esc](https://github.com/mjibson/esc) - **Star : 456** 将文件嵌入到Go程序中并提供http文件系统接口。![star > 100][Bronze]
...
* [statik](https://github.com/rakyll/statik) - **Star : 2020** 将静态文件嵌入到Go可执行文件中。![star > 1000][Silver]
* [templify](https://github.com/wlbr/templify) - **Star : 19** 将外部模板文件嵌入到Go代码中，以创建单个文件二进制文件。
* [vfsgen](https://github.com/shurcooL/vfsgen) - **Star : 632** 生成一个vfsdata。静态实现给定虚拟文件系统的go文件。![star > 100][Bronze]
...
* [go-dsp](https://github.com/mjibson/go-dsp) - **Star : 623** Go数字信号处理。![star > 100][Bronze]![最近一年没有更新][Yellow]
...
* [gosl](https://github.com/cpmech/gosl) - **Star : 1289** 提供线性代数，FFT，几何，NURBS，数值方法，概率，优化，微分方程，等等。![star > 1000][Silver]
...
* [acmetool](https://github.com/hlandau/acme) - **Star : 1690** ACME(让我们用自动更新加密)客户端工具。![star > 1000][Silver]
...
* [asn1](https://github.com/PromonLogicalis/asn1) - **Star : 39** 面向golang的BER和DER编码库。
...
* [mapstructure](https://github.com/mitchellh/mapstructure) - **Star : 2315** 用于对原生键值对进行解码生成 Go 语言结构体![star > 1000][Silver]
...
* [fasttemplate](https://github.com/valyala/fasttemplate) - **Star : 287** 简单快速的模板引擎。进行模板元素替换时，速度是比[text/template](http://golang.org/pkg/text/template/)快10倍。![star > 100][Bronze]
...
* [raymond](https://github.com/aymerick/raymond) - **Star : 335** 使用 Go 语言实现的完整的 handlebars![star > 100][Bronze]
...
* Testing Frameworks
    ...
    * [baloo](https://github.com/h2non/baloo) - **Star : 634** 表达性强、多功能的、端到端的HTTP API 测试工具![star > 100][Bronze]
...
* Specific Formats
    ...
    * [bluemonday](https://github.com/microcosm-cc/bluemonday) - **Star : 1212** HTML 清理工具![star > 1000][Silver]
    ...
    * [toml](https://github.com/BurntSushi/toml) - **Star : 2707** TOML配置格式(带反射的编码器/解码器)。![star > 1000][Silver]
* Utility
...
* [coinpaprika-go](https://github.com/coinpaprika/coinpaprika-api-go-client) - **Star : 10** Coinpaprika API的客户端。
...
* [immortal](https://github.com/immortal/immortal) - **Star : 598** \*nix 跨平台 (与操作系统无关的)监控程序。![star > 100][Bronze]
...
* [profile](https://github.com/pkg/profile) - **Star : 977** Go的简单分析支持包。![star > 100][Bronze]
...
* [request](https://github.com/mozillazg/request) - **Star : 353** Go 语言版的 HTTP Requests for Humans™.。![star > 100][Bronze]![最近一年没有更新][Yellow]
...
* [wuzz](https://github.com/asciimoo/wuzz) - **Star : 8190** 用于HTTP检查的交互式cli工具。![star > 5000][Gold]
...
* [tigertonic](https://github.com/rcrowley/go-tigertonic) - **Star : 998** 用于构建 JSON web 服务的 Go 语言框架，受到 Dropwizard 的启发。![star > 100][Bronze]
...
* [Tollbooth](https://github.com/didip/tollbooth) - **Star : 1208** 限制速率的 HTTP 请求处理程序。![star > 1000][Silver]
...
* [render](https://github.com/unrolled/render) - **Star : 1259** Go package用于方便地呈现JSON、XML和HTML模板响应。![star > 1000][Silver]
...
* [go-callvis](https://github.com/TrueFurby/go-callvis) - **Star : 1917** 使用 dot format 可视化 Go 程序的调用图。![star > 1000][Silver]
...
* [bombardier](https://github.com/codesenberg/bombardier) - **Star : 1674** 快速跨平台 HTTP 基准测试工具。![star > 1000][Silver]
...
* [GVM](https://github.com/moovweb/gvm) - **Star : 4405** GVM 提供了一个接口来管理 Go 版本。![star > 1000][Silver]
...
* [kcli](https://github.com/cswank/kcli) - **Star : 65** 用于检查kafka主题/分区/消息的命令行工具。
...
* [snap](https://github.com/intelsdi-x/snap) - **Star : 1801** 强大的遥测框架。![star > 1000][Silver]
...
* [go-web-framework-benchmark](https://github.com/smallnest/go-web-framework-benchmark) - **Star : 974** web框架基准测试。![star > 100][Bronze]
...
* [gophers](https://github.com/egonelbre/gophers) - **Star : 1546** Free gophers.![star > 1000][Silver]
...
* [Go Cheat Sheet](https://github.com/a8m/go-lang-cheat-sheet) - **Star : 3968**  Go's reference card。![star > 1000][Silver]
