...
* [goworker](https://github.com/benmanns/goworker) - **Star : 2220** **最近提交 : 2019-02-06**  基于 go 的后台 worker。![star > 1000][Silver]
...
* [grpool](https://github.com/ivpusic/grpool) - **Star : 487** **最近提交 : 2019-01-28**  轻量级协程池。![star > 100][Bronze]
...
* [pool](https://github.com/go-playground/pool) - **Star : 471** **最近提交 : 2016-08-24**  有限消费者协程或无限协程池，可用于更加简单的处理和取消协程![star > 100][Bronze]
...
* [tunny](https://github.com/Jeffail/tunny) - **Star : 1293** **最近提交 : 2018-11-09**  golang 的协程池。![star > 1000][Silver]
* [worker-pool](https://github.com/vardius/worker-pool) - **Star : 43** **最近提交 : 2019-06-07**  一个简单的 Go 异步工作池。
* [workerpool](https://github.com/gammazero/workerpool) - **Star : 118** **最近提交 : 2019-06-09**  限制任务执行并发数，而不是队列中的任务数量的协程池，。![star > 100][Bronze]
...
* [app](https://github.com/murlokswarm/app) - **Star : 2912** **最近提交 : 2019-06-16**  用于创建包含了 GO, HTML 和 CSS 的应用程序。支持 MacOS, Windows 正在开发中。![star > 1000][Silver]
* [fyne](https://github.com/fyne-io/fyne) - **Star : 6004** **最近提交 : 2019-07-01**  为 Go 而设计的跨平台的本地GUIs，使用EFL呈现。支持 : Linux, macOS, Windows。![star > 5000][Gold]
* [go-astilectron](https://github.com/asticode/go-astilectron) - **Star : 2591** **最近提交 : 2019-06-26**  使用 GO 和 HTML/JS/CSS (电子驱动)进行构建跨平台 GUI 应用程序。![star > 1000][Silver]
* [go-gtk](http://mattn.github.io/go-gtk/) - 实现了 GTK 的 Go接口。
* [go-sciter](https://github.com/sciter-sdk/go-sciter) - **Star : 1415** **最近提交 : 2019-05-23**  实现了 Sciter 的 Go 接口 : 用于现代桌面 UI 开发的可嵌入HTML/CSS/脚本引擎。可跨平台。![star > 1000][Silver]
* [gotk3](https://github.com/gotk3/gotk3) - **Star : 728** **最近提交 : 2019-06-20**  实现了 GTK3 的 Go接口。![star > 100][Bronze]
* [gowd](https://github.com/dtylman/gowd) - **Star : 201** **最近提交 : 2019-06-19**  跨平台、快速、简单的桌面UI开发，采用了GO, HTML, CSS和NW.js实现。![star > 100][Bronze]
* [qt](https://github.com/therecipe/qt) - **Star : 5797** **最近提交 : 2019-06-28**  实现了 Qt 的 Go接口(支持Windows / macOS / Linux / Android / iOS / Sailfish OS / Raspberry Pi)。![star > 5000][Gold]
* [ui](https://github.com/andlabs/ui) - **Star : 6821** **最近提交 : 2019-03-28**  跨平台的 Platform-native GUI 库。![star > 5000][Gold]
* [Wails](https://wails.app) - Mac, Windows, Linux桌面应用程序，主要基于含有内置的OS HTML渲染器的HTML UI。
* [walk](https://github.com/lxn/walk) - **Star : 3626** **最近提交 : 2019-06-22**  Windows应用程序库。![star > 1000][Silver]
* [webview](https://github.com/zserge/webview) - **Star : 4508** **最近提交 : 2019-06-28**  跨平台webview窗口，具有简单的双向JavaScript绑定(Windows / macOS / Linux)。![star > 1000][Silver]

*交互*

* [go-appindicator](https://github.com/dawidd6/go-appindicator) - **Star : 1** **最近提交 : 2019-05-21**  实现了 libappindicator3 C库 的 Go接口。
* [gosx-notifier](https://github.com/deckarep/gosx-notifier) - **Star : 492** **最近提交 : 2019-05-02**  OSX 桌面通知库。![star > 100][Bronze]
...
* [robotgo](https://github.com/go-vgo/robotgo) - **Star : 4344** **最近提交 : 2019-06-30**  实现跨平台的GUI系统自动化。包含了控制鼠标、键盘等功能。![star > 1000][Silver]
* [systray](https://github.com/getlantern/systray) - **Star : 751** **最近提交 : 2019-06-26**  跨平台 Go 库，可在通知区放置图标和菜单。![star > 100][Bronze]
* [trayhost](https://github.com/shurcooL/trayhost) - **Star : 158** **最近提交 : 2018-10-21**  跨平台 Go 库，可用于在主机操作系统的任务栏中放置图标。![star > 100][Bronze]
...
* [bild](https://github.com/anthonynsimon/bild) - **Star : 2016** **最近提交 : 2019-06-24**  纯Go语言实现的图像处理算法合集。![star > 1000][Silver]
* [bimg](https://github.com/h2non/bimg) - **Star : 767** **最近提交 : 2019-03-21**  使用libvips实现的快速高效的图像处理包。![star > 100][Bronze]
* [cameron](https://github.com/aofei/cameron) - **Star : 30** **最近提交 : 2019-05-05**  一个Go语言的头像生成器。
* [geopattern](https://github.com/pravj/geopattern) - **Star : 1008** **最近提交 : 2019-01-09**  由字符串创建漂亮图案的图片生成器。![star > 1000][Silver]
* [gg](https://github.com/fogleman/gg) - **Star : 1867** **最近提交 : 2019-06-12**  纯Go语言实现的2D渲染。![star > 1000][Silver]
* [gift](https://github.com/disintegration/gift) - **Star : 1203** **最近提交 : 2019-03-23**  图像处理包。![star > 1000][Silver]
...
* [go-nude](https://github.com/koyachi/go-nude) - **Star : 279** **最近提交 : 2018-11-22**  Go语言实现的裸照检测工具。![star > 100][Bronze]
* [go-opencv](https://github.com/lazywei/go-opencv) - **Star : 1079** **最近提交 : 2019-05-24**  OpenCV库的Go bindings。![star > 1000][Silver]
* [go-webcolors](https://github.com/jyotiska/go-webcolors) - **Star : 24** **最近提交 : 2015-08-21**  Python下webcolors库的Go语言调用。
* [gocv](https://github.com/hybridgroup/gocv) - **Star : 2353** **最近提交 : 2019-06-18**  使用OpenCV 3.3+实现的计算机视觉(ComputerVision)的Go语言包。![star > 1000][Silver]
* [goimagehash](https://github.com/corona10/goimagehash) - **Star : 206** **最近提交 : 2019-03-19**   图像哈希处理的Go语言包。![star > 100][Bronze]
* [goimghdr](https://github.com/corona10/goimghdr) - **Star : 26** **最近提交 : 2019-06-14**  Go语言实现的imghdr模块用于确定文件的图像类型。
* [govatar](https://github.com/o1egl/govatar) - **Star : 307** **最近提交 : 2019-04-15**  生成有趣头像的库和CMD工具。![star > 100][Bronze]
* [image2ascii](https://github.com/qeesung/image2ascii) - **Star : 282** **最近提交 : 2018-11-07**  将图像转换为ASCII码。![star > 100][Bronze]
* [imagick](https://github.com/gographics/imagick) - **Star : 951** **最近提交 : 2019-01-15**   ImageMagick下MagickWand的C API的Go binding。![star > 100][Bronze]
* [imaginary](https://github.com/h2non/imaginary) - **Star : 2541** **最近提交 : 2019-06-29**  用于图像大小调整的快速、简单的HTTP微服务。![star > 1000][Silver]
* [imaging](https://github.com/disintegration/imaging) - **Star : 2459** **最近提交 : 2019-06-11**  简单的Go图像处理包。![star > 1000][Silver]
* [img](https://github.com/hawx/img) - **Star : 128** **最近提交 : 2015-05-01**  图像处理工具的集合。![star > 100][Bronze]
* [ln](https://github.com/fogleman/ln) - **Star : 2439** **最近提交 : 2018-02-24**  Go实现的3D线艺术（3D Line Art）渲染。![star > 1000][Silver]
* [mergi](https://github.com/noelyahan/mergi) - **Star : 68** **最近提交 : 2019-05-14**  用于图像处理(合并、裁剪、调整大小、水印、动画)的工具和Go库。
* [mort](https://github.com/aldor007/mort) - **Star : 362** **最近提交 : 2019-04-22**  Go语言实现的图像存储和处理服务器。![star > 100][Bronze]
* [mpo](https://github.com/donatj/mpo) - **Star : 6** **最近提交 : 2019-01-26**  MPO三维照片的解码和转换工具。
* [picfit](https://github.com/thoas/picfit) - **Star : 1049** **最近提交 : 2019-05-31**  Go实现的图像调整服务器。![star > 1000][Silver]
* [pt](https://github.com/fogleman/pt) - **Star : 1750** **最近提交 : 2019-03-21**  Go实现的路径跟踪（path tracing）引擎。![star > 1000][Silver]
* [resize](https://github.com/nfnt/resize) - **Star : 2107** **最近提交 : 2018-02-22**  Go实现的使用常用的插值法（interpolation methods）调整图像大小的库。![star > 1000][Silver]
* [rez](https://github.com/bamiaux/rez) - **Star : 181** **最近提交 : 2017-08-01**  纯Go语言和SIMD实现的图像大小调整。![star > 100][Bronze]
* [smartcrop](https://github.com/muesli/smartcrop) - **Star : 1239** **最近提交 : 2019-04-22**  为任意图片寻找合适的位置进行图片裁剪。![star > 1000][Silver]
* [steganography](https://github.com/auyer/steganography) - **Star : 25** **最近提交 : 2019-05-06**  纯Go实现的LSB隐写（LSB steganography）的库。
* [stegify](https://github.com/DimitarPetrov/stegify) - **Star : 480** **最近提交 : 2019-05-15**   Go实现的LSB隐写（LSB steganography），能够隐藏任何文件到一个图像中。![star > 100][Bronze]
* [svgo](https://github.com/ajstarks/svgo) - **Star : 1307** **最近提交 : 2018-10-06**   Go实现的SVG生成库。![star > 1000][Silver]
...
* [connectordb](https://github.com/connectordb/connectordb) - **Star : 166** **最近提交 : 2019-03-01**  自我量化和物联网的开源平台。![star > 100][Bronze]
* [devices](https://github.com/goiot/devices) - **Star : 224** **最近提交 : 2016-07-10**  一套用于物联网设备的库，实验性地用于x/exp/io。![star > 100][Bronze]
* [eywa](https://github.com/xcodersun/eywa) - **Star : 35** **最近提交 : 2017-04-12**  Eywa是一个用于跟踪连接的设备连接管理器。
* [flogo](https://github.com/tibcosoftware/flogo) - **Star : 1089** **最近提交 : 2019-06-19**  Flogo是一个面向物联网边缘应用和集成的开源框架。![star > 1000][Silver]
* [gatt](https://github.com/paypal/gatt) - **Star : 806** **最近提交 : 2019-05-14**  Gatt是一个用于构建低能耗蓝牙外围设备的Go语言包。![star > 100][Bronze]
* [gobot](https://github.com/hybridgroup/gobot/) - Gobot是一个用于机器人、物理计算和物联网的框架。
* [huego](https://github.com/amimof/huego) - **Star : 107** **最近提交 : 2019-05-27**  一个包含广泛的Philips Hue客户端的Go语言库。![star > 100][Bronze]
* [iot](https://github.com/vaelen/iot/) - IoT是一个实现谷歌物联网核心设备的简单框架。
* [mainflux](https://github.com/Mainflux/mainflux) - **Star : 551** **最近提交 : 2019-07-01**  工业物联网消息和设备管理服务器。![star > 100][Bronze]
* [periph](https://periph.io/) - 外围设备I/O与低级板(low-level board)设备接口。
* [sensorbee](https://github.com/sensorbee/sensorbee) - **Star : 175** **最近提交 : 2017-12-31**  轻量级物联网流处理引擎。![star > 100][Bronze]
...
* [go-cron](https://github.com/rk/go-cron) - **Star : 177** **最近提交 : 2015-05-15**  一个Go实现的简单的定时任务库。可以在不同的时间间隔（每秒一次到在每年在特定的日期执行）执行闭包或函数。主要用于web应用和长时间运行的守护进程。![star > 100][Bronze]
* [gron](https://github.com/roylee0704/gron) - **Star : 622** **最近提交 : 2019-02-24**  使用简单的Go API定义基于时间的任务。 之后Gron的调度程序将运行它们。![star > 100][Bronze]
* [JobRunner](https://github.com/bamzi/jobrunner) - **Star : 559** **最近提交 : 2016-10-19**  智能和功能丰富的cron作业调度程序（包含任务队列和实时监控）。![star > 100][Bronze]
* [jobs](https://github.com/albrow/jobs) - **Star : 449** **最近提交 : 2018-06-17**  持久和灵活的后台作业库。![star > 100][Bronze]
* [leprechaun](https://github.com/kilgaloon/leprechaun) - **Star : 36** **最近提交 : 2019-04-25**  支持webhook、crons和经典调度的作业调度程序。
* [scheduler](https://github.com/carlescere/scheduler) - **Star : 290** **最近提交 : 2018-06-14**  Cronjobs让调度变得很简单。![star > 100][Bronze]
...
* [GJSON](https://github.com/tidwall/gjson) - **Star : 4701** **最近提交 : 2019-07-01**  使用一行代码获取JSON的值。![star > 1000][Silver]
* [go-respond](https://github.com/nicklaw5/go-respond) - **Star : 20** **最近提交 : 2019-06-30**  用于处理常见的HTTP JSON响应的Go语言库。
* [gojq](https://github.com/elgs/gojq) - **Star : 139** **最近提交 : 2018-05-31**  Go语言实现的JSON请求。![star > 100][Bronze]
* [gojson](https://github.com/ChimeraCoder/gojson) - **Star : 2016** **最近提交 : 2019-06-07**  从JSON自动生成Go的结构（struct）定义。![star > 1000][Silver]
...
* [kazaam](https://github.com/Qntfy/kazaam) - **Star : 123** **最近提交 : 2019-06-06**  用于任意JSON文档转换的API。![star > 100][Bronze]
...
* [glog](https://github.com/golang/glog) - **Star : 2260** **最近提交 : 2019-06-01**  为Go提供了水平的执行日志。![star > 1000][Silver]
...
* [go-logger](https://github.com/apsdehal/go-logger) - **Star : 229** **最近提交 : 2019-05-16**  简单的日志程序的 Go 程序，与级别处理程序。![star > 100][Bronze]
...
* [log](https://github.com/apex/log) - **Star : 720** **最近提交 : 2019-06-24**  Go的结构化日志包。![star > 100][Bronze]
* [log](https://github.com/go-playground/log) - **Star : 265** **最近提交 : 2019-05-21**  简单、可配置和可伸缩的Go结构化日志。![star > 100][Bronze]
...
* [log15](https://github.com/inconshreveable/log15) - **Star : 877** **最近提交 : 2019-06-13**  简单、强大的Go日志。![star > 100][Bronze]
...
* [logger](https://github.com/azer/logger) - **Star : 135** **最近提交 : 2019-06-30**  Go的最小化日志库。![star > 100][Bronze]
...
* [logrus](https://github.com/Sirupsen/logrus) - **Star : 11424** **最近提交 : 2019-06-28**  结构化的日志 Go 。![star > 5000][Gold]
...
* [logutils](https://github.com/hashicorp/logutils) - **Star : 247** **最近提交 : 2018-08-29**  用于稍微更好地登录的实用程序Go (Golang)扩展了标准日志记录器。![star > 100][Bronze]
* [logxi](https://github.com/mgutz/logxi) - **Star : 332** **最近提交 : 2019-06-15**  12因素的应用程序日志程序是快速的，让你快乐。![star > 100][Bronze]
* [lumberjack](https://github.com/natefinch/lumberjack) - **Star : 1379** **最近提交 : 2019-07-01**  简单的滚动日志程序，实现io.WriteCloser。![star > 1000][Silver]
* [mlog](https://github.com/jbrodriguez/mlog) - **Star : 17** **最近提交 : 2018-08-06**  简单的go日志模块，有5个级别，可选的旋转日志文件功能和stdout/stderr输出。
* [onelog](https://github.com/francoispqt/onelog) - **Star : 325** **最近提交 : 2019-03-06**  Onelog是一个非常简单但非常高效的JSON日志程序。它是所有场景中速度最快的JSON日志程序。而且，它是配置最低的日志记录器之一。![star > 100][Bronze]
* [ozzo-log](https://github.com/go-ozzo/ozzo-log) - **Star : 108** **最近提交 : 2018-04-06**  支持日志严重性、分类和过滤的高性能日志记录。可以发送过滤日志消息到各种目标(如控制台，网络，邮件)。![star > 100][Bronze]
...
* [seelog](https://github.com/cihub/seelog) - **Star : 1335** **最近提交 : 2019-03-04**  具有灵活调度、过滤和格式化的日志功能。![star > 1000][Silver]
* [spew](https://github.com/davecgh/go-spew) - **Star : 3231** **最近提交 : 2019-04-21**  为Go数据结构实现一个漂亮的深层打印机，以帮助调试。![star > 1000][Silver]
* [stdlog](https://github.com/alexcesaro/log) - **Star : 43** **最近提交 : 2015-09-16**  Stdlog是一个面向对象的库，提供水平日志记录。它对cron作业非常有用。
* [tail](https://github.com/hpcloud/tail) - **Star : 1494** **最近提交 : 2019-06-12**  Go软件包努力模拟BSD tail程序的特性。![star > 1000][Silver]
* [xlog](https://github.com/xfxdev/xlog) - **Star : 7** **最近提交 : 2019-01-15**  插件架构和灵活的日志系统的Go，与级别ctrl，多日志目标和自定义日志格式。
* [xlog](https://github.com/rs/xlog) - **Star : 130** **最近提交 : 2019-06-25**  结构化记录器'net/context`意识到HTTP处理程序的灵活调度。![star > 100][Bronze]
* [zap](https://github.com/uber-go/zap) - **Star : 7171** **最近提交 : 2019-06-26**  快速、结构化、水平登录Go。![star > 5000][Gold]
* [zerolog](https://github.com/rs/zerolog) - **Star : 2092** **最近提交 : 2019-06-28**  零JSON记录器。![star > 1000][Silver]

## 机器学习

*机器学习库。*

* [bayesian](https://github.com/jbrukh/bayesian) - **Star : 625** **最近提交 : 2019-03-20**  Golang的朴素贝叶斯分类。![star > 100][Bronze]
* [CloudForest](https://github.com/ryanbressler/CloudForest) - **Star : 642** **最近提交 : 2018-11-20**  快速、灵活、多线程的决策树集成，用于纯Go中的机器学习。![star > 100][Bronze]
* [eaopt](https://github.com/MaxHalford/eaopt) - **Star : 615** **最近提交 : 2019-03-25**  一个进化优化库。![star > 100][Bronze]
...
* [go-deep](https://github.com/patrikeh/go-deep) - **Star : 213** **最近提交 : 2018-09-14**  一个功能丰富的神经网络库在 Go 。![star > 100][Bronze]
* [go-fann](https://github.com/white-pony/go-fann) - **Star : 99** **最近提交 : 2015-02-04**  快速人工神经网络(FANN)库的Go绑定。
* [go-galib](https://github.com/thoj/go-galib) - **Star : 170** **最近提交 : 2015-12-29**  用Go / golang编写的遗传算法库。![star > 100][Bronze]
* [go-pr](https://github.com/daviddengcn/go-pr) - **Star : 57** **最近提交 : 2013-06-08**  模式识别包在Go lang。
* [gobrain](https://github.com/goml/gobrain) - **Star : 365** **最近提交 : 2019-06-30**  用 Go 编写的神经网络。![star > 100][Bronze]
...
* [GoLearn](https://github.com/sjwhitworth/golearn) - **Star : 6593** **最近提交 : 2019-06-20**  通用机器学习库。![star > 5000][Gold]
...
* [goml](https://github.com/cdipaolo/goml) - **Star : 1001** **最近提交 : 2019-04-13**  在线机器学习在 Go 。![star > 1000][Silver]
* [goRecommend](https://github.com/timkaye11/goRecommend) - **Star : 141** **最近提交 : 2014-07-29**  推荐算法库用Go编写。![star > 100][Bronze]
* [gorgonia](https://github.com/chewxy/gorgonia) - **Star : 2643** **最近提交 : 2019-06-29**  基于图形的计算库，如Theano for Go，它为构建各种机器学习和神经网络算法提供了基本框架。![star > 1000][Silver]
* [gorse](https://github.com/zhenghaoz/gorse) - **Star : 508** **最近提交 : 2019-06-14**  基于协同过滤的Go高性能推荐系统包。![star > 100][Bronze]
* [goscore](https://github.com/asafschers/goscore) - **Star : 34** **最近提交 : 2019-05-04**   Go 为PMML评分API。
* [gosseract](https://github.com/otiai10/gosseract) - **Star : 841** **最近提交 : 2019-05-30**  使用Tesseract c++库为OCR(光学字符识别)打包。![star > 100][Bronze]
...
* [ocrserver](https://github.com/otiai10/ocrserver) - **Star : 216** **最近提交 : 2019-03-21**  一个简单的OCR API服务器，非常容易被Docker和Heroku部署。![star > 100][Bronze]
* [onnx-go](https://github.com/owulveryck/onnx-go) - **Star : 137** **最近提交 : 2019-07-01**  Go接口打开神经网络交换(ONNX)。![star > 100][Bronze]
* [probab](https://github.com/ThePaw/probab) - **Star : 10** **最近提交 : 2015-09-14**  概率分布函数。贝叶斯推理。用纯 Go 写的。
* [regommend](https://github.com/muesli/regommend) - **Star : 243** **最近提交 : 2019-04-24**  推荐&协同过滤引擎。![star > 100][Bronze]
* [shield](https://github.com/eaigner/shield) - **Star : 124** **最近提交 : 2016-03-16**  贝叶斯文本分类器，具有灵活的令牌器和存储后端。![star > 100][Bronze]
* [tfgo](https://github.com/galeone/tfgo) - **Star : 1156** **最近提交 : 2019-05-27**  易于使用的Tensorflow绑定:简化了官方Tensorflow Go绑定的使用。在Go中定义计算图形，加载和执行Python中训练的模型。![star > 1000][Silver]
...
* [APNs2](https://github.com/sideshow/apns2) - **Star : 2021** **最近提交 : 2019-06-18**  HTTP / 2苹果推送通知供应商——发送推送通知到iOS, tvo, Safari和OSX的应用。![star > 1000][Silver]
* [Beaver](https://github.com/Clivern/Beaver) - **Star : 711** **最近提交 : 2019-06-01**  一个实时消息服务器，可构建一个可伸缩的应用程序内通知，多人游戏，聊天应用程序在web和移动应用程序。![star > 100][Bronze]
* [Benthos](https://github.com/Jeffail/benthos) - **Star : 1899** **最近提交 : 2019-07-01**  一系列协议之间的消息流桥。![star > 1000][Silver]
* [Bus](https://github.com/mustafaturan/bus) - **Star : 110** **最近提交 : 2019-05-24**  内部通信的最小消息总线实现。![star > 100][Bronze]
* [Centrifugo](https://github.com/centrifugal/centrifugo) - **Star : 3611** **最近提交 : 2019-06-28**  实时消息(Websockets或SockJS)服务器。![star > 1000][Silver]
* [Commander](https://github.com/jeroenrinzema/commander) - **Star : 19** **最近提交 : 2019-06-13**  高级事件驱动的消费者/生产者，支持各种“方言”，如Apache Kafka。
* [dbus](https://github.com/godbus/dbus) - **Star : 350** **最近提交 : 2019-06-24**  D-Bus的本地Go绑定。![star > 100][Bronze]
* [drone-line](https://github.com/appleboy/drone-line) - **Star : 58** **最近提交 : 2018-11-11**  使用二进制、docker或从属CI发送[Line](https://at.line.me/en)通知。
* [emitter](https://github.com/olebedev/emitter) - **Star : 307** **最近提交 : 2019-01-10**  使用通配符、谓词、取消可能性和许多其他优点，使用Go way发出事件。![star > 100][Bronze]
* [event](https://github.com/agoalofalife/event) - **Star : 27** **最近提交 : 2018-02-19**  模式观察者的实现。
* [EventBus](https://github.com/asaskevich/EventBus) - **Star : 539** **最近提交 : 2019-06-05**  具有异步兼容性的轻量级事件总线。![star > 100][Bronze]
* [gaurun-client](https://github.com/osamingo/gaurun-client) - **Star : 8** **最近提交 : 2019-05-10**  用Go编写的Gaurun客户端。
* [Glue](https://github.com/desertbit/glue) - **Star : 312** **最近提交 : 2019-06-29**  健壮的Go和Javascript套接字库(替代Socket.io)。![star > 100][Bronze]
* [go-notify](https://github.com/TheCreeper/go-notify) - **Star : 47** **最近提交 : 2019-02-10**  本地实现的freedesktop通知规范。
* [go-nsq](https://github.com/nsqio/go-nsq) - **Star : 1435** **最近提交 : 2019-03-29**  NSQ的官方Go包。![star > 1000][Silver]
* [go-socket.io](https://github.com/googollee/go-socket.io) - **Star : 2827** **最近提交 : 2019-05-29**  套接字。面向golang的io库，一个实时应用程序框架。![star > 1000][Silver]
* [go-vitotrol](https://github.com/maxatome/go-vitotrol) - **Star : 11** **最近提交 : 2019-05-12**  客户端库到Viessmann Vitotrol web服务。
* [Gollum](https://github.com/trivago/gollum) - **Star : 761** **最近提交 : 2019-06-07**  n:m多路复用器，它收集来自不同来源的消息并将其广播到一组目的地。![star > 100][Bronze]
* [golongpoll](https://github.com/jcuga/golongpoll) - **Star : 418** **最近提交 : 2019-02-18**  HTTP longpoll服务器库，使web发布-订阅变得简单。![star > 100][Bronze]
* [goose](https://github.com/ian-kent/goose) - **Star : 37** **最近提交 : 2014-12-21**  服务器在Go中发送事件。
* [gopush-cluster](https://github.com/Terry-Mao/gopush-cluster) - **Star : 1820** **最近提交 : 2017-06-07**  gopush-cluster是一个gopush服务器集群。![star > 1000][Silver]
* [gorush](https://github.com/appleboy/gorush) - **Star : 3623** **最近提交 : 2019-06-27**  使用[APNs2](https://github.com/sideshow/apns2)和谷歌[GCM](https://github.com/google/go-gcm)推送通知服务器。![star > 1000][Silver]
* [guble](https://github.com/smancke/guble) - **Star : 138** **最近提交 : 2017-11-01**  消息服务器使用推送通知(谷歌Firebase云消息、苹果推送通知服务、SMS)以及websockets，一个REST API，具有分布式操作和消息持久性。![star > 100][Bronze]
...
* [machinery](https://github.com/RichardKnop/machinery) - **Star : 3298** **最近提交 : 2019-06-27**  基于分布式消息传递的异步任务队列/作业队列。![star > 1000][Silver]
* [mangos](https://github.com/go-mangos/mangos) - **Star : 1531** **最近提交 : 2019-06-28**  具有传输互操作性的Nanomsg(“可伸缩协议”)的纯go实现。![star > 1000][Silver]
* [melody](https://github.com/olahol/melody) - **Star : 1509** **最近提交 : 2019-07-01**  处理websocket会话的极简框架，包括广播和自动乒乓球处理。![star > 1000][Silver]
* [Mercure](https://github.com/dunglas/mercure) - **Star : 1432** **最近提交 : 2019-06-28**  使用Mercure协议(构建在服务器发送事件之上)分派服务器发送的更新的服务器和库。![star > 1000][Silver]
...
* [NATS Go Client](https://github.com/nats-io/nats) - **Star : 2336** **最近提交 : 2019-06-08**  轻量级和高性能的发布-订阅和分布式队列消息传递系统——这是Go库。![star > 1000][Silver]
...
* [pubsub](https://github.com/tuxychandru/pubsub) - **Star : 270** **最近提交 : 2019-04-11**  简单的pubsubpackage for go。![star > 100][Bronze]
...
* [sarama](https://github.com/Shopify/sarama) - **Star : 4446** **最近提交 : 2019-06-30**   Go Apache Kafka的库。![star > 1000][Silver]
* [Uniqush-Push](https://github.com/uniqush/uniqush-push) - **Star : 1092** **最近提交 : 2019-06-14**  Redis支持面向移动设备的服务器端通知的统一推送服务。![star > 1000][Silver]
* [zmq4](https://github.com/pebbe/zmq4) - **Star : 770** **最近提交 : 2019-06-26**  转接口到ZeroMQ版本4。也可用于[版本3](https://github.com/pebbe/zmq3)和[版本2](https://github.com/pebbe/zmq2)。![star > 100][Bronze]
...
* [excelize](https://github.com/360EntSecGroup-Skylar/excelize) - **Star : 4249** **最近提交 : 2019-07-01**  Golang库读写Microsoft Excel™(XLSX)文件。![star > 1000][Silver]
...
* [xlsx](https://github.com/tealeg/xlsx) - **Star : 3268** **最近提交 : 2019-06-05**  库，以简化在Go程序中读取Microsoft Excel最新版本使用的XML格式。![star > 1000][Silver]
...
* [dig](https://github.com/uber-go/dig) - **Star : 859** **最近提交 : 2019-06-17**  一个基于反射的Go依赖注入工具包。![star > 100][Bronze]
* [fx](https://github.com/uber-go/fx) - **Star : 635** **最近提交 : 2019-06-24**  基于依赖注入的Go应用程序框架(构建在dig之上)。![star > 100][Bronze]
...
* [golang-standards/project-layout](https://github.com/golang-standards/project-layout) - **Star : 8394** **最近提交 : 2019-06-10**  Go生态系统中常见的历史和新兴的项目布局模式。![star > 5000][Gold]
...
* [xstrings](https://github.com/huandu/xstrings) - **Star : 605** **最近提交 : 2018-09-06**  从其他语言移植的有用字符串函数的集合。![star > 100][Bronze]
...
* [antch](https://github.com/antchfx/antch) - **Star : 137** **最近提交 : 2018-07-28**  一个快速、强大和可扩展的web爬行和抓取框架。![star > 100][Bronze]
* [archiver](https://github.com/mholt/archiver) - **Star : 2396** **最近提交 : 2019-06-28**  用于生成和提取.zip和.tar.gz存档的库和命令。![star > 1000][Silver]
...
* [banner](https://github.com/dimiro1/banner) - **Star : 229** **最近提交 : 2016-11-08**  在Go应用程序中添加漂亮的横幅。![star > 100][Bronze]
* [base64Captcha](https://github.com/mojocn/base64Captcha) - **Star : 604** **最近提交 : 2019-05-20**  Base64captch支持数字，数字，字母，算术，音频和数字-字母验证码。![star > 100][Bronze]
* [battery](https://github.com/distatus/battery) - **Star : 134** **最近提交 : 2019-04-14**  跨平台、标准化的电池信息库。![star > 100][Bronze]
...
* [conv](https://github.com/cstockton/go-conv) - **Star : 341** **最近提交 : 2017-05-24**  包conv提供了跨Go类型的快速和直观的转换。![star > 100][Bronze]
* [datacounter](https://github.com/miolini/datacounter) - **Star : 27** **最近提交 : 2018-04-10**  读取器/写入器/http.ResponseWriter的计数器。
* [ffmt](https://github.com/go-ffmt/ffmt) - **Star : 126** **最近提交 : 2019-06-10**  美化数据显示为人类。![star > 100][Bronze]
* [ghorg](https://github.com/gabrie30/ghorg) - **Star : 22** **最近提交 : 2018-12-09**  将所有repos从GitHub org复制到一个目录中。
* [go-commons-pool](https://github.com/jolestar/go-commons-pool) - **Star : 649** **最近提交 : 2019-05-26**  Golang的通用对象池。![star > 100][Bronze]
* [go-openapi](https://github.com/go-openapi) - 用于解析和利用开放api模式的包的集合。
* [go-resiliency](https://github.com/eapache/go-resiliency) - **Star : 831** **最近提交 : 2019-06-14**   Go 的弹性模式。![star > 100][Bronze]
* [go-unarr](https://github.com/gen2brain/go-unarr) - **Star : 66** **最近提交 : 2019-02-03**  用于RAR、TAR、ZIP和7z存档的解压缩库。
* [gofakeit](https://github.com/brianvoe/gofakeit) - **Star : 403** **最近提交 : 2019-06-25**  用go编写的随机数据生成器。![star > 100][Bronze]
* [gommit](https://github.com/antham/gommit) - **Star : 65** **最近提交 : 2019-06-19**  分析git提交消息，确保它们遵循已定义的模式。
* [gopsutil](https://github.com/shirou/gopsutil) - **Star : 3791** **最近提交 : 2019-06-30**  用于检索进程和系统利用率(CPU、内存、磁盘等)的跨平台库。![star > 1000][Silver]
* [gosh](https://github.com/osamingo/gosh) - **Star : 16** **最近提交 : 2019-04-30**  提供Go统计处理程序，结构，测量方法。
* [gosms](https://github.com/haxpax/gosms) - **Star : 1220** **最近提交 : 2017-07-07**  您自己的本地短信网关在Go，可以用来发送短信。![star > 1000][Silver]
* [gotoprom](https://github.com/cabify/gotoprom) - **Star : 15** **最近提交 : 2019-06-05**  为Prometheus客户端提供类型安全的度量构建器包装库。
* [gountries](https://github.com/pariz/gountries) - **Star : 205** **最近提交 : 2019-05-23**  公开国家和细分数据的包。![star > 100][Bronze]
* [health](https://github.com/dimiro1/health) - **Star : 359** **最近提交 : 2019-05-20**  易于使用，可扩展的健康检查库。![star > 100][Bronze]
...
* [lk](https://github.com/hyperboloide/lk) - **Star : 111** **最近提交 : 2019-05-31**  一个简单的golang授权库。![star > 100][Bronze]
* [llvm](https://github.com/llir/llvm) - **Star : 403** **最近提交 : 2019-07-01**  用于在纯Go中与LLVM IR交互的库。![star > 100][Bronze]
...
* [shortid](https://github.com/teris-io/shortid) - **Star : 442** **最近提交 : 2017-10-29**  分布式生成超短、唯一、非顺序、URL友好的id。![star > 100][Bronze]
* [stats](https://github.com/go-playground/stats) - **Star : 120** **最近提交 : 2016-09-07**  显示器 Go MemStats +系统统计，如内存，交换和CPU，并通过UDP发送到任何地方，你想记录等…![star > 100][Bronze]
...
* [go-pinyin](https://github.com/mozillazg/go-pinyin) - **Star : 512** **最近提交 : 2019-04-06**  中文汉字到汉语拼音的转换。![star > 100][Bronze]
...
* [gojieba](https://github.com/yanyiwu/gojieba) - **Star : 788** **最近提交 : 2018-10-05**  这是一个Go实现的[jieba](https://github.com/fxsjy/jieba)，这是一个中文分词算法。![star > 100][Bronze]
...
* [gse](https://github.com/go-ego/gse) - **Star : 1036** **最近提交 : 2019-06-29**  高效的文本分割;支持英语、汉语、日语等。![star > 1000][Silver]
* [icu](https://github.com/goodsign/icu) - **Star : 19** **最近提交 : 2017-03-30**  Cgo绑定用于icu4c C库的检测和转换功能。保证与版本50.1兼容。
* [kagome](https://github.com/ikawaha/kagome) - **Star : 411** **最近提交 : 2019-06-05**  JP形态学分析仪编写的纯Go。![star > 100][Bronze]
...
* [nlp](https://github.com/Shixzie/nlp) - **Star : 354** **最近提交 : 2017-09-18**  从字符串中提取值并用nlp填充结构。![star > 100][Bronze]
* [nlp](https://github.com/james-bowman/nlp) - **Star : 212** **最近提交 : 2019-04-08**  支持LSA(潜在语义分析)的Go自然语言处理库。![star > 100][Bronze]
...
* [prose](https://github.com/jdkato/prose) - **Star : 2018** **最近提交 : 2019-02-04**  用于支持标记化、词性标记、名称实体提取等文本处理的库。![star > 1000][Silver]
...
* [sentences](https://github.com/neurosnap/sentences) - **Star : 261** **最近提交 : 2019-04-17**  句子标记器:将文本转换为句子列表。![star > 100][Bronze]
...
* [whatlanggo](https://github.com/abadojack/whatlanggo) - **Star : 342** **最近提交 : 2019-03-06**  Go的自然语言检测包。支持84种语言和24种脚本(书写系统，如拉丁语、西里尔语等)。![star > 100][Bronze]
* [when](https://github.com/olebedev/when) - **Star : 923** **最近提交 : 2019-05-09**  带有可插入规则的自然EN和RU语言日期/时间解析器。![star > 100][Bronze]

## 网络

*用于处理网络各层的库。*

* [arp](https://github.com/mdlayher/arp) - **Star : 191** **最近提交 : 2019-03-14**  包arp实现了arp协议，如RFC 826中所述。![star > 100][Bronze]
* [buffstreams](https://github.com/stabbycutyou/buffstreams) - **Star : 229** **最近提交 : 2017-06-02**  通过TCP传输协议缓冲区数据变得很容易。![star > 100][Bronze]
* [canopus](https://github.com/zubairhamed/canopus) - **Star : 134** **最近提交 : 2018-03-26**  CoAP客户机/服务器实现(RFC 7252)。![star > 100][Bronze]
* [cidranger](https://github.com/yl2chen/cidranger) - **Star : 376** **最近提交 : 2019-01-19**  快速IP到CIDR查找 Go 。![star > 100][Bronze]
* [dhcp6](https://github.com/mdlayher/dhcp6) - **Star : 60** **最近提交 : 2019-03-12**  包dhcp6实现了一个DHCPv6服务器，如RFC 3315所述。
* [dns](https://github.com/miekg/dns) - **Star : 3712** **最近提交 : 2019-06-28**  使用DNS的库。![star > 1000][Silver]
* [ether](https://github.com/songgao/ether) - **Star : 62** **最近提交 : 2016-04-05**  用于发送和接收以太网帧的跨平台Go包。
* [ethernet](https://github.com/mdlayher/ethernet) - **Star : 182** **最近提交 : 2019-06-06**  包以太网实现了对IEEE 802.3以太网II帧和IEEE 802.1Q VLAN标签的编组和解组。![star > 100][Bronze]
* [fasthttp](https://github.com/valyala/fasthttp) - **Star : 9015** **最近提交 : 2019-06-30**  软件包fasthttp是Go的一个快速HTTP实现，比net/http快10倍。![star > 5000][Gold]
* [fortio](https://github.com/fortio/fortio) - **Star : 828** **最近提交 : 2019-06-18**  负载测试库和命令行工具，先进的echo服务器和web UI。允许指定一组每秒查询的负载，并记录延迟直方图和其他有用的统计数据，并将它们作图。Tcp、Http、gRPC。![star > 100][Bronze]
* [ftp](https://github.com/jlaffaye/ftp) - **Star : 500** **最近提交 : 2019-06-24**  包ftp实现了[RFC 959](http://tools.ietf.org/html/rfc959)中描述的ftp客户机。![star > 100][Bronze]
...
* [go-getter](https://github.com/hashicorp/go-getter) - **Star : 686** **最近提交 : 2019-06-30**   Go 图书馆下载文件或目录从各种来源使用一个URL。![star > 100][Bronze]
* [go-stun](https://github.com/ccding/go-stun) - **Star : 321** **最近提交 : 2018-07-26**  Go实现了STUN客户机(RFC 3489和RFC 5389)。![star > 100][Bronze]
* [gobgp](https://github.com/osrg/gobgp) - **Star : 1647** **最近提交 : 2019-07-01**  用 Go 编程语言实现的BGP。![star > 1000][Silver]
...
* [gopacket](https://github.com/google/gopacket) - **Star : 2776** **最近提交 : 2019-06-30**  使用libpcap绑定访问包处理库。![star > 1000][Silver]
* [gopcap](https://github.com/akrennmair/gopcap) - **Star : 347** **最近提交 : 2017-01-25**   Go 包装libpcap。![star > 100][Bronze]
* [goshark](https://github.com/sunwxg/goshark) - **Star : 9** **最近提交 : 2017-10-24**  goshark包使用tshark来解码IP包，并创建数据结构来分析包。
* [gosnmp](https://github.com/soniah/gosnmp) - **Star : 424** **最近提交 : 2019-06-20**  用于执行SNMP操作的本机Go库。![star > 100][Bronze]
* [gotcp](https://github.com/gansidui/gotcp) - **Star : 406** **最近提交 : 2017-04-18**   Go 包快速编写tcp应用程序。![star > 100][Bronze]
* [grab](https://github.com/cavaliercoder/grab) - **Star : 539** **最近提交 : 2019-04-28**   Go 软件包管理文件下载。![star > 100][Bronze]
* [graval](https://github.com/koofr/graval) - **Star : 25** **最近提交 : 2018-06-06**  实验FTP服务器框架。
* [HTTPLab](https://github.com/gchaincl/httplab) - **Star : 3369** **最近提交 : 2019-06-05**  HTTPLabs允许您检查HTTP请求并伪造响应。![star > 1000][Silver]
...
* [jazigo](https://github.com/udhos/jazigo) - **Star : 122** **最近提交 : 2018-08-31**  Jazigo是一个用Go编写的工具，用于检索多个网络设备的配置。![star > 100][Bronze]
* [kcp-go](https://github.com/xtaci/kcp-go) - **Star : 2193** **最近提交 : 2019-06-26**  快速可靠的ARQ协议。![star > 1000][Silver]
* [kcptun](https://github.com/xtaci/kcptun) - **Star : 10515** **最近提交 : 2019-07-01**  非常简单和快速udp隧道基于KCP协议。![star > 5000][Gold]
* [lhttp](https://github.com/fanux/lhttp) - **Star : 506** **最近提交 : 2018-04-08**  强大的websocket框架，使您的IM服务器更容易构建。![star > 100][Bronze]
...
* [mdns](https://github.com/hashicorp/mdns) - **Star : 541** **最近提交 : 2019-04-19**  Golang中的简单mDNS(多播DNS)客户机/服务器库。![star > 100][Bronze]
* [mqttPaho](https://eclipse.org/paho/clients/golang/) - Paho Go客户机提供一个MQTT客户机库，用于通过TCP、TLS或WebSockets连接到MQTT代理。
* [NFF-Go](https://github.com/intel-go/nff-go) - **Star : 643** **最近提交 : 2019-07-01**  快速开发云计算和裸机网络功能的框架(原YANFF)。![star > 100][Bronze]
* [packet](https://github.com/aerogo/packet) - **Star : 26** **最近提交 : 2019-05-27**  通过TCP和UDP发送数据包。如果需要，它可以缓冲消息和热交换连接。
* [peerdiscovery](https://github.com/schollz/peerdiscovery) - **Star : 356** **最近提交 : 2019-02-21**  使用UDP组播进行跨平台本地对等点发现的纯Go库。![star > 100][Bronze]
...
* [quic-go](https://github.com/lucas-clemente/quic-go) - **Star : 2796** **最近提交 : 2019-07-01**  在纯Go中实现了QUIC协议。![star > 1000][Silver]
* [raw](https://github.com/mdlayher/raw) - **Star : 298** **最近提交 : 2019-06-25**  Package raw支持在设备驱动程序级别读取和写入网络接口的数据。![star > 100][Bronze]
* [sftp](https://github.com/pkg/sftp) - **Star : 711** **最近提交 : 2019-06-14**  包sftp实现了SSH文件传输协议，如https://filezilla-project.org/specs/draft-ietf-secsh-filexfer-02.txt所述。![star > 100][Bronze]
* [ssh](https://github.com/gliderlabs/ssh) - **Star : 1087** **最近提交 : 2019-06-20**  用于构建SSH服务器的高级API(封装密码/ SSH)。![star > 1000][Silver]
* [sslb](https://github.com/eduardonunesp/sslb) - **Star : 113** **最近提交 : 2019-05-16**  它是一个超级简单的负载平衡器，只是一个实现某种性能的小项目。![star > 100][Bronze]
* [stun](https://github.com/go-rtc/stun) - **Star : 255** **最近提交 : 2019-05-10**  Go实现的RFC 5389 STUN协议。![star > 100][Bronze]
* [tcp_server](https://github.com/firstrow/tcp_server) - **Star : 275** **最近提交 : 2019-04-24**   Go 图书馆建设tcp服务器更快。![star > 100][Bronze]
* [tspool](https://github.com/two/tspool) - **Star : 5** **最近提交 : 2018-10-29**  TCP库使用工作池来提高性能并保护服务器。
* [utp](https://github.com/anacrolix/utp) - **Star : 150** **最近提交 : 2018-02-19**  Go uTP微传输协议的实现。![star > 100][Bronze]
* [water](https://github.com/songgao/water) - **Star : 826** **最近提交 : 2019-06-23**  简单TUN / TAP图书馆。![star > 100][Bronze]
* [webrtc](https://github.com/pions/webrtc) - **Star : 2032** **最近提交 : 2019-07-01**  WebRTC API的纯Go实现。![star > 1000][Silver]
* [winrm](https://github.com/masterzen/winrm) - **Star : 207** **最近提交 : 2019-03-08**   Go WinRM客户端远程执行Windows机器上的命令。![star > 100][Bronze]
...
* [gentleman](https://github.com/h2non/gentleman) - **Star : 669** **最近提交 : 2019-01-28**  功能齐全的插件驱动HTTP客户端库。![star > 100][Bronze]
* [goreq](https://github.com/smallnest/goreq) - **Star : 98** **最近提交 : 2018-07-27**  基于gorequest的增强简化HTTP客户机。
* [grequests](https://github.com/levigross/grequests) - **Star : 1391** **最近提交 : 2019-02-14**  一个 Go “克隆”的伟大和著名的请求库。![star > 1000][Silver]
* [heimdall](https://github.com/gojektech/heimdall) - **Star : 1047** **最近提交 : 2019-04-10**  具有重试和hystrix功能的增强http客户机。![star > 1000][Silver]
* [pester](https://github.com/sethgrid/pester) - **Star : 319** **最近提交 : 2019-01-27**  使用重试、后退和并发执行HTTP客户机调用。![star > 100][Bronze]
* [rq](https://github.com/ddo/rq) - **Star : 25** **最近提交 : 2018-10-20**  golang stdlib HTTP客户端更好的接口。
* [sling](https://github.com/dghubble/sling) - **Star : 845** **最近提交 : 2019-03-05**  Sling是一个用于创建和发送API请求的Go HTTP客户端库。![star > 100][Bronze]

## OpenGL

*用于在Go中使用OpenGL的库。*

* [gl](https://github.com/go-gl/gl) - **Star : 627** **最近提交 : 2019-03-21**  OpenGL的Go绑定(通过glow生成)。![star > 100][Bronze]
* [glfw](https://github.com/go-gl/glfw) - **Star : 709** **最近提交 : 2019-04-12**  Go绑定用于glfw3。![star > 100][Bronze]
* [goxjs/gl](https://github.com/goxjs/gl) - **Star : 131** **最近提交 : 2018-11-05**  跨平台的OpenGL绑定(OS X, Linux, Windows，浏览器，iOS, Android)。![star > 100][Bronze]
* [goxjs/glfw](https://github.com/goxjs/glfw) - **Star : 58** **最近提交 : 2018-11-05**  使用跨平台glfw库创建OpenGL上下文并接收事件。
* [mathgl](https://github.com/go-gl/mathgl) - **Star : 286** **最近提交 : 2019-04-17**  纯Go数学软件包专门为三维数学，与灵感来自GLM。![star > 100][Bronze]
...
* [go-pg](https://github.com/go-pg/pg) - **Star : 2871** **最近提交 : 2019-06-30**  关注PostgreSQL的特性和性能。![star > 1000][Silver]
* [go-queryset](https://github.com/jirfag/go-queryset) - **Star : 443** **最近提交 : 2019-03-17**  100%类型安全ORM与代码生成和MySQL, PostgreSQL, Sqlite3, SQL Server支持基于GORM。![star > 100][Bronze]
* [go-sqlbuilder](https://github.com/huandu/go-sqlbuilder) - **Star : 219** **最近提交 : 2019-05-23**  一个灵活而强大的SQL字符串构建器库加上一个零配置ORM。![star > 100][Bronze]
* [go-store](https://github.com/gosuri/go-store) - **Star : 92** **最近提交 : 2017-02-23**  简单而快速的Redis支持的键值存储库。
* [GORM](https://github.com/jinzhu/gorm) - **Star : 14113** **最近提交 : 2019-07-01**  Golang出色的ORM库的目标是对开发人员友好。![star > 5000][Gold]
* [gorp](https://github.com/go-gorp/gorp) - **Star : 3059** **最近提交 : 2019-06-17**  Go的关系持久性，ORM-ish库。![star > 1000][Silver]
* [grimoire](https://github.com/Fs02/grimoire) - **Star : 110** **最近提交 : 2019-06-18**  Grimoire是golang的数据库访问层和验证。(支持:MySQL, PostgreSQL和SQLite3)。![star > 100][Bronze]
...
* [pop/soda](https://github.com/gobuffalo/pop) - **Star : 655** **最近提交 : 2019-06-30**  数据库迁移、创建、ORM等。用于MySQL、PostgreSQL和SQLite。![star > 100][Bronze]
* [QBS](https://github.com/coocood/qbs) - **Star : 536** **最近提交 : 2017-04-18**  表示结构查询。一个ORM。![star > 100][Bronze]
* [reform](https://github.com/go-reform/reform) - **Star : 786** **最近提交 : 2019-07-01**  更好的ORM for Go，基于非空接口和代码生成。![star > 100][Bronze]
* [SQLBoiler](https://github.com/volatiletech/sqlboiler) - **Star : 2200** **最近提交 : 2019-06-30**  ORM生成器。根据您的数据库模式生成一个功能强大且运行速度快的ORM。![star > 1000][Silver]
* [upper.io/db](https://github.com/upper/db) - **Star : 1814** **最近提交 : 2019-01-27**  通过使用封装成熟数据库驱动程序的适配器与不同数据源交互的单一接口。![star > 1000][Silver]
* [Xorm](https://github.com/go-xorm/xorm) - **Star : 4998** **最近提交 : 2019-06-27**  简单而强大的ORM for Go。![star > 1000][Silver]
* [Zoom](https://github.com/albrow/zoom) - **Star : 237** **最近提交 : 2018-06-17**  基于Redis的快速数据存储和查询引擎。![star > 100][Bronze]
...
* [dep](https://github.com/golang/dep) - **Star : 12382** **最近提交 : 2019-06-24**   Go 的依赖管理工具，需要 Go 1.9+![star > 5000][Gold]
* [vgo](https://go.googlesource.com/vgo/) - Go 命令版本管理

*用于包和依赖项管理的非官方库。*

* [gigo](https://github.com/LyricalSecurity/gigo) - **Star : 196** **最近提交 : 2018-12-01**  类似pip的golang依赖工具，支持私有存储库和散列。![star > 100][Bronze]
* [glide](https://github.com/Masterminds/glide) - **Star : 7737** **最近提交 : 2019-06-19**  轻松管理您的 golang 第三方包。受Maven、Bundler和Pip等工具的启发。![star > 5000][Gold]
* [godep](https://github.com/tools/godep) - **Star : 5652** **最近提交 : 2018-04-13**  godep是go的依赖工具，它通过修复包的依赖关系来帮助构建可重复的包。![star > 5000][Gold]
* [gom](https://github.com/mattn/gom) - **Star : 1353** **最近提交 : 2018-05-21**  Go Manager - bundle for Go。![star > 1000][Silver]
* [goop](https://github.com/nitrous-io/goop) - **Star : 779** **最近提交 : 2015-12-02**  Go 的简单依赖管理器，灵感来自Bundler。![star > 100][Bronze]
* [gop](https://github.com/lunny/gop) - **Star : 50** **最近提交 : 2019-03-22**  在GOPATH之外构建和管理Go应用程序。
* [gopm](https://github.com/gpmgo/gopm) - **Star : 2327** **最近提交 : 2019-06-08**  包管理器。![star > 1000][Silver]
* [govendor](https://github.com/kardianos/govendor) - **Star : 4659** **最近提交 : 2019-06-14**  包管理器。使用 vendor 文件的 Go vendor 工具。![star > 1000][Silver]
* [gpm](https://github.com/pote/gpm) - **Star : 1204** **最近提交 : 2017-09-28**  基本的 Go 依赖管理器。![star > 1000][Silver]
* [johnny-deps](https://github.com/VividCortex/johnny-deps) - **Star : 213** **最近提交 : 2014-09-17**  使用Git的最小依赖版本。![star > 100][Bronze]
* [mvn-golang](https://github.com/raydac/mvn-golang) - **Star : 87** **最近提交 : 2019-06-24**  插件，为自动加载Golang SDK，依赖关系管理和启动Maven项目基础设施中的构建环境提供了方法。
* [nut](https://github.com/jingweno/nut) - **Star : 246** **最近提交 : 2015-06-26**  vendor 依赖。![star > 100][Bronze]
* [VenGO](https://github.com/DamnWidget/VenGO) - **Star : 116** **最近提交 : 2016-07-14**  创建和管理可导出的隔离go虚拟环境。![star > 100][Bronze]

## 查询语言

* [gojsonq](https://github.com/thedevsaddam/gojsonq) - **Star : 832** **最近提交 : 2019-05-28**  一个用来查询JSON数据的Go包。![star > 100][Bronze]
* [graphql](https://github.com/tmc/graphql) - **Star : 51** **最近提交 : 2017-06-02**  graphql解析器+工具集
* [graphql](https://github.com/neelance/graphql-go) - **Star : 2694** **最近提交 : 2019-06-25**  关注易用性的GraphQL服务器。![star > 1000][Silver]
* [graphql-go](https://github.com/graphql-go/graphql) - **Star : 5043** **最近提交 : 2019-06-20**  为Go实现GraphQL。![star > 5000][Gold]
* [jsonql](https://github.com/elgs/jsonql) - **Star : 201** **最近提交 : 2019-04-02**  Golang中的JSON查询表达式库。![star > 100][Bronze]
* [jsonslice](https://github.com/bhmj/jsonslice) - **Star : 22** **最近提交 : 2019-05-22**  使用高级过滤器查询Jsonpath。
* [rql](https://github.com/a8m/rql) - **Star : 109** **最近提交 : 2019-05-23**  用于REST API的资源查询语言。![star > 100][Bronze]

## 嵌入的资源

* [esc](https://github.com/mjibson/esc) - **Star : 456** **最近提交 : 2019-04-02**  将文件嵌入到Go程序中并提供http文件系统接口。![star > 100][Bronze]
* [fileb0x](https://github.com/UnnoTed/fileb0x) - **Star : 416** **最近提交 : 2019-01-08**  一个可定制的工具用来在Go中嵌入文件![star > 100][Bronze]
* [go-embed](https://github.com/pyros2097/go-embed) - **Star : 14** **最近提交 : 2016-06-02**  生成go代码，将资源文件嵌入到库或可执行文件中。
* [go-resources](https://github.com/omeid/go-resources) - **Star : 155** **最近提交 : 2019-03-24**  嵌入到Go中的普通资源。![star > 100][Bronze]
* [go.rice](https://github.com/GeertJohan/go.rice) - **Star : 1617** **最近提交 : 2019-05-01**  go.rice 是一个Go包，它使处理html、js、css、图像和模板等资源变得非常容易。![star > 1000][Silver]
* [packr](https://github.com/gobuffalo/packr) - **Star : 2009** **最近提交 : 2019-06-28**  将静态文件嵌入到Go二进制文件中的简单方法。![star > 1000][Silver]
* [statics](https://github.com/go-playground/statics) - **Star : 53** **最近提交 : 2016-10-05**  将静态资源嵌入到go文件中，用于单个二进制编译+使用http。文件系统+符号链接。
* [statik](https://github.com/rakyll/statik) - **Star : 2020** **最近提交 : 2019-03-24**  将静态文件嵌入到Go可执行文件中。![star > 1000][Silver]
* [templify](https://github.com/wlbr/templify) - **Star : 19** **最近提交 : 2019-05-26**  将外部模板文件嵌入到Go代码中，以创建单个文件二进制文件。
* [vfsgen](https://github.com/shurcooL/vfsgen) - **Star : 632** **最近提交 : 2019-02-14**  生成一个vfsdata。静态实现给定虚拟文件系统的go文件。![star > 100][Bronze]
...
* [chart](https://github.com/vdobler/chart) - **Star : 573** **最近提交 : 2019-02-18**  简单的图表绘制库。支持多种图形类型。![star > 100][Bronze]
...
* [ewma](https://github.com/VividCortex/ewma) - **Star : 264** **最近提交 : 2019-05-22**  提供指数加权移动平均算法。![star > 100][Bronze]
* [geom](https://github.com/skelterjohn/geom) - **Star : 40** **最近提交 : 2018-01-03**   Go 的二维几何。
* [go-dsp](https://github.com/mjibson/go-dsp) - **Star : 623** **最近提交 : 2018-05-08**  Go数字信号处理。![star > 100][Bronze]
...
* [gohistogram](https://github.com/VividCortex/gohistogram) - **Star : 126** **最近提交 : 2018-03-27**  数据流的近似直方图。![star > 100][Bronze]
* [gonum](https://github.com/gonum/gonum) - **Star : 2843** **最近提交 : 2019-06-29**  Gonum是一组用于Go编程语言的数字库。它包含用于矩阵、统计、优化等的库。![star > 1000][Silver]
* [gonum/plot](https://github.com/gonum/plot) - **Star : 1180** **最近提交 : 2019-06-15**  gonum/plot提供了一个API，用于在Go中构建和绘制绘图。![star > 1000][Silver]
* [goraph](https://github.com/gyuho/goraph) - **Star : 597** **最近提交 : 2017-10-01**  纯Go图论库(数据结构，算法可视化)。![star > 100][Bronze]
* [gosl](https://github.com/cpmech/gosl) - **Star : 1289** **最近提交 : 2019-02-28**  提供线性代数，FFT，几何，NURBS，数值方法，概率，优化，微分方程，等等。![star > 1000][Silver]
* [GoStats](https://github.com/OGFris/GoStats) - **Star : 9** **最近提交 : 2019-01-15**  GoStats是一个开放源码的GoLang库，主要用于机器学习领域的数学统计，它涵盖了大多数统计度量函数。
* [graph](https://github.com/yourbasic/graph) - **Star : 225** **最近提交 : 2017-12-08**  基本图形算法库。![star > 100][Bronze]
* [ode](https://github.com/ChristopherRabotin/ode) - **Star : 10** **最近提交 : 2017-03-18**  常微分方程(ODE)求解器，支持扩展状态和基于信道的迭代停止条件。
* [orb](https://github.com/paulmach/orb) - **Star : 184** **最近提交 : 2019-06-26**  2D几何类型，支持剪切、GeoJSON和Mapbox矢量平铺。![star > 100][Bronze]
...
* [stats](https://github.com/montanaflynn/stats) - **Star : 1330** **最近提交 : 2019-05-03**  包含Golang标准库中缺少的公共函数的统计软件包。![star > 1000][Silver]
* [streamtools](https://github.com/nytlabs/streamtools) - **Star : 1315** **最近提交 : 2015-07-17**  通用图形工具，用于处理数据流。![star > 1000][Silver]
...
* [acmetool](https://github.com/hlandau/acme) - **Star : 1690** **最近提交 : 2018-08-10**  ACME(让我们用自动更新加密)客户端工具。![star > 1000][Silver]
* [acra](https://github.com/cossacklabs/acra) - **Star : 441** **最近提交 : 2019-06-25**  网络加密代理保护基于数据库的应用程序免受数据泄漏:强选择性加密，SQL注入预防，入侵检测系统。![star > 100][Bronze]
...
* [BadActor](https://github.com/jaredfolkins/badactor) - **Star : 241** **最近提交 : 2017-06-06**  一个驻留在内存中的，应用驱动的监控程序，受 fail2ban 的启发![star > 100][Bronze]
* [Cameradar](https://github.com/Ullaakut/cameradar) - **Star : 1772** **最近提交 : 2019-06-29**  工具和库，以远程入侵RTSP流从监控摄像头。![star > 1000][Silver]
* [certificates](https://github.com/mvmaasakkers/certificates) - **Star : 6** **最近提交 : 2019-06-17**  用于生成tls证书的自定义工具。
* [go-yara](https://github.com/hillu/go-yara) - **Star : 132** **最近提交 : 2019-03-14**  YARA的 Go 语言接口，号称是 “对于恶意软件研究者（以及其他人）来说是模式匹配的瑞士军刀”![star > 100][Bronze]
...
* [lego](https://github.com/xenolf/lego) - **Star : 3418** **最近提交 : 2019-06-28**  纯 Go ACME 客户端库及命令行工具![star > 1000][Silver]
* [memguard](https://github.com/awnumar/memguard) - **Star : 995** **最近提交 : 2019-06-28**  一个用于处理内存中敏感值的纯Go库。![star > 100][Bronze]
* [nacl](https://github.com/kevinburke/nacl) - **Star : 450** **最近提交 : 2019-01-02**   Go 实现NaCL API的集合。![star > 100][Bronze]
* [passlib](https://github.com/hlandau/passlib) - **Star : 224** **最近提交 : 2019-03-31**  不过时的密码哈希库。![star > 100][Bronze]
* [secure](https://github.com/unrolled/secure) - **Star : 1184** **最近提交 : 2019-06-25**  Go 语言 HTTP 中间件，为 Go 提供了一些安全功能![star > 1000][Silver]
* [simple-scrypt](https://github.com/elithrar/simple-scrypt) - **Star : 154** **最近提交 : 2019-07-01**  Scrypt 库，具有简单、易懂的 API，同时具有内置的自动校准功能![star > 100][Bronze]
* [ssh-vault](https://github.com/ssh-vault/ssh-vault) - **Star : 194** **最近提交 : 2018-12-14**  使用ssh密钥加密/解密。![star > 100][Bronze]
...
* [colfer](https://github.com/pascaldekloe/colfer) - **Star : 469** **最近提交 : 2019-06-13**  为Colfer二进制格式生成代码。![star > 100][Bronze]
* [csvutil](https://github.com/jszwec/csvutil) - **Star : 299** **最近提交 : 2019-05-08**  高性能、惯用的CSV记录编码和解码到本机Go结构。![star > 100][Bronze]
* [fwencoder](https://github.com/o1egl/fwencoder) - **Star : 6** **最近提交 : 2018-01-15**  用于Go的固定宽度文件解析器(编码和解码库)。
* [go-capnproto](https://github.com/glycerine/go-capnproto) - **Star : 273** **最近提交 : 2019-01-18**  Go 语言用的 Cap'n Proto 库及解析器![star > 100][Bronze]
* [go-codec](https://github.com/ugorji/go) - **Star : 1206** **最近提交 : 2019-06-29**  高性能、多功能、规范化编码解码以及 rpc 库， 用于 msgpack, cbor 和 json，支持基于运行时的 OR 码生成![star > 1000][Silver]
* [gogoprotobuf](https://github.com/gogo/protobuf) - **Star : 2828** **最近提交 : 2019-06-21**  Go 语言的 Protocol Buffer 库。![star > 1000][Silver]
* [goprotobuf](https://github.com/golang/protobuf) - **Star : 4847** **最近提交 : 2019-06-29**  通过库和协议编译器插件使 Go 语言支持 Google的 protocol buffers.![star > 1000][Silver]
* [jsoniter](https://github.com/json-iterator/go) - **Star : 5255** **最近提交 : 2019-06-22**  高性能，100% 兼容的“encoding/json” 替代品![star > 5000][Gold]
* [mapstructure](https://github.com/mitchellh/mapstructure) - **Star : 2315** **最近提交 : 2019-03-26**  用于对原生键值对进行解码生成 Go 语言结构体![star > 1000][Silver]
* [php_session_decoder](https://github.com/yvasiyarov/php_session_decoder) - **Star : 118** **最近提交 : 2018-11-02**  用于协同 PHP session 格式数据和 PHP 序列化／反序列化函数工作的go语言库![star > 100][Bronze]
* [structomap](https://github.com/tuvistavie/structomap) - **Star : 91** **最近提交 : 2019-05-24**  用于从静态结构体简单、动态的生成键值对的库

## 服务器应用程序

* [algernon](https://github.com/xyproto/algernon) - **Star : 1572** **最近提交 : 2019-06-03**  内置支持Lua、Markdown、GCSS和Amber的HTTP/2 web服务器。![star > 1000][Silver]
* [Caddy](https://github.com/mholt/caddy) - **Star : 22470** **最近提交 : 2019-06-29**  Caddy是另一种HTTP/2 web服务器，易于配置和使用。![star > 5000][Gold]
* [consul](https://www.consul.io/) - Consul 是一个用于服务发现、监控和配置的工具
* [devd](https://github.com/cortesi/devd) - **Star : 2781** **最近提交 : 2019-06-26**  为开发人员提供本地web服务器。![star > 1000][Silver]
* [discovery](https://github.com/Bilibili/discovery) - **Star : 624** **最近提交 : 2019-06-25**  用于弹性中间层负载平衡和故障转移的注册表。![star > 100][Bronze]
* [etcd](https://github.com/coreos/etcd) - **Star : 25734** **最近提交 : 2019-06-29**  为共享配置和服务发现提供高可用的键值存储。![star > 5000][Gold]
* [Fider](https://github.com/getfider/fider) - **Star : 767** **最近提交 : 2019-05-29**  Fider是一个收集和组织客户反馈的开放平台。![star > 100][Bronze]
* [Flagr](https://github.com/checkr/flagr) - **Star : 779** **最近提交 : 2019-06-28**  Flagr是一个开源特性标记和A/B测试服务。![star > 100][Bronze]
* [flipt](https://github.com/markphelps/flipt) - **Star : 974** **最近提交 : 2019-07-01**  一个用Go和Vue.js编写的自包含特性标志解决方案![star > 100][Bronze]
* [jackal](https://github.com/ortuman/jackal) - **Star : 704** **最近提交 : 2019-06-17**  用Go编写的XMPP服务器。![star > 100][Bronze]
* [minio](https://github.com/minio/minio) - **Star : 16807** **最近提交 : 2019-07-01**  Minio是一个分布式对象存储服务器。![star > 5000][Gold]
...
* [RoadRunner](https://github.com/spiral/roadrunner) - **Star : 3128** **最近提交 : 2019-06-30**  高性能PHP应用服务器，负载平衡器和进程管理器。![star > 1000][Silver]
...
* [ace](https://github.com/yosssi/ace) - **Star : 761** **最近提交 : 2018-06-17**  Ace 是一个 Go 语言的 HTML 模板引擎，受到了 Slim 和 Jade 的启发。 Ace 是对Gold的一种改进。![star > 100][Bronze]
* [amber](https://github.com/eknkc/amber) - **Star : 821** **最近提交 : 2018-08-24**  Amber是一个优雅的Go编程语言模板引擎，它的灵感来自HAML和Jade。![star > 100][Bronze]
* [damsel](https://github.com/dskinner/damsel) - **Star : 20** **最近提交 : 2016-04-07**  标记语言，通过css选择器实现了 html 框架 ，并可以通过 pkg html/template 等进行扩展
* [ego](https://github.com/benbjohnson/ego) - **Star : 409** **最近提交 : 2019-01-10**  轻量级模板语言，允许您在Go中编写模板。模板被翻译成Go并编译。![star > 100][Bronze]
...
* [fasttemplate](https://github.com/valyala/fasttemplate) - **Star : 287** **最近提交 : 2019-03-29**  简单快速的模板引擎。进行模板元素替换时，速度是比[text/template](http://golang.org/pkg/text/template/)快10倍。![star > 100][Bronze]
* [gofpdf](https://github.com/jung-kurt/gofpdf) - **Star : 2996** **最近提交 : 2019-06-24**  PDF 文档生成器，支持文本，绘图和图片![star > 1000][Silver]
* [goview](https://github.com/foolin/goview) - **Star : 38** **最近提交 : 2019-06-08**  Goview是一个轻量级、极简的模板库，基于golang html/template构建Go web应用程序。
* [hero](https://github.com/shiyanhui/hero) - **Star : 1192** **最近提交 : 2019-06-07**  Hero是一个方便、快速和强大的go模板引擎。![star > 1000][Silver]
* [jet](https://github.com/CloudyKit/jet) - **Star : 576** **最近提交 : 2019-06-19**  Jet模板引擎。![star > 100][Bronze]
...
* [mustache](https://github.com/hoisie/mustache) - **Star : 964** **最近提交 : 2018-05-26**  Go 语言实现的 Mustache 模板语言![star > 100][Bronze]
* [pongo2](https://github.com/flosch/pongo2) - **Star : 1478** **最近提交 : 2019-06-19**  类似 DjanGo 的模板引擎![star > 1000][Silver]
* [quicktemplate](https://github.com/valyala/quicktemplate) - **Star : 1357** **最近提交 : 2019-04-24**  快速、强大且易用的模板引擎。将模板转化为 Go 语言并进行编译![star > 1000][Silver]
* [raymond](https://github.com/aymerick/raymond) - **Star : 335** **最近提交 : 2019-02-02**  使用 Go 语言实现的完整的 handlebars![star > 100][Bronze]
* [Razor](https://github.com/sipin/gorazor) - **Star : 670** **最近提交 : 2019-06-21**  Go 语言的 Razor 视图引擎![star > 100][Bronze]
* [Soy](https://github.com/robfig/soy) - **Star : 143** **最近提交 : 2019-03-20**  Go 语言实现的谷歌闭包模板(也就是 Soy templates) ,遵循[官方规范](https://developer.google.com/closure/templates/)。![star > 100][Bronze]
...
* Testing Frameworks
    ...
    * [baloo](https://github.com/h2non/baloo) - **Star : 634** **最近提交 : 2019-01-10**  表达性强、多功能的、端到端的HTTP API 测试工具![star > 100][Bronze]
    ...
    * [charlatan](https://github.com/percolate/charlatan) - **Star : 188** **最近提交 : 2018-09-26**  为测试生成假接口实现的工具。![star > 100][Bronze]
    ...
    * [frisby](https://github.com/verdverm/frisby) - **Star : 246** **最近提交 : 2019-06-07**  REST API测试框架。![star > 100][Bronze]
    * [ginkgo](http://onsi.github.io/ginkgo/) - Go的BDD测试框架。
    * [go-carpet](https://github.com/msoap/go-carpet) - **Star : 195** **最近提交 : 2019-03-18**  在终端中查看测试覆盖率的工具。![star > 100][Bronze]
    * [go-cmp](https://github.com/google/go-cmp) - **Star : 1084** **最近提交 : 2019-06-07**  用于比较测试中的Go值的包。![star > 1000][Silver]
    * [go-mutesting](https://github.com/zimmski/go-mutesting) - **Star : 244** **最近提交 : 2018-11-25**  变异测试的Go源代码。![star > 100][Bronze]
    * [go-testdeep](https://github.com/maxatome/go-testdeep) - **Star : 49** **最近提交 : 2019-06-21**  极具灵活性的golang深度比较，扩展了go测试包。
    * [go-vcr](https://github.com/dnaeon/go-vcr) - **Star : 325** **最近提交 : 2019-06-27**  记录并回放HTTP交互，以便进行快速、确定和准确的测试。![star > 100][Bronze]
    * [goblin](https://github.com/franela/goblin) - **Star : 613** **最近提交 : 2019-03-31**  类似Mocha的测试框架。![star > 100][Bronze]
    ...
    * [godog](https://github.com/DATA-DOG/godog) - **Star : 716** **最近提交 : 2019-05-29**  类似 Cucumber 或 Behat 的 BDD 框架![star > 100][Bronze]
    * [gofight](https://github.com/appleboy/gofight) - **Star : 252** **最近提交 : 2019-06-11**  对 Go 语言的路由框架进行 API 测试![star > 100][Bronze]
    ...
    * [GoSpec](https://github.com/orfjackal/gospec) - **Star : 111** **最近提交 : 2014-08-01**  用于 Go 编程语言的bdd风格的测试框架。![star > 100][Bronze]
    ...
    * [gotest.tools](https://github.com/gotestyourself/gotest.tools) - **Star : 112** **最近提交 : 2019-06-27**  一组包，用于增强go测试包并支持公共模式。![star > 100][Bronze]
    * [Hamcrest](https://github.com/rdrdr/hamcrest) - **Star : 26** **最近提交 : 2011-02-15**  用于声明性 Matcher 对象的连贯框架，当将其应用于输入值时，将产生自描述结果。
    * [httpexpect](https://github.com/gavv/httpexpect) - **Star : 1103** **最近提交 : 2019-06-19**  简洁的、声明式的、易用的端到端HTTP 及 REST API 测试![star > 1000][Silver]
    ...
    * [testfixtures](https://github.com/go-testfixtures/testfixtures) - **Star : 314** **最近提交 : 2019-05-02**  类似 Rails 的测试工具，用于测试数据库应用![star > 100][Bronze]
    * [Testify](https://github.com/stretchr/testify) - **Star : 7771** **最近提交 : 2019-06-13**  对标准测试包的扩展。![star > 5000][Gold]
...
* Mock
    * [counterfeiter](https://github.com/maxbrunsfeld/counterfeiter) - **Star : 353** **最近提交 : 2019-06-27**  用于生成自包含 mock 对象的工具![star > 100][Bronze]
    * [go-sqlmock](https://github.com/DATA-DOG/go-sqlmock) - **Star : 1623** **最近提交 : 2019-06-21**  Mock SQL ，用于测试数据库交互![star > 1000][Silver]
    * [go-txdb](https://github.com/DATA-DOG/go-txdb) - **Star : 154** **最近提交 : 2019-06-01**  基于单事务的数据库驱动，主要用于测试目的![star > 100][Bronze]
    * [gock](https://github.com/h2non/gock) - **Star : 786** **最近提交 : 2019-06-18**  多功能、易用 HTTP mock![star > 100][Bronze]
    * [gomock](https://github.com/golang/mock) - **Star : 2668** **最近提交 : 2019-06-21**  用于Go编程语言的mock框架。![star > 1000][Silver]
    * [govcr](https://github.com/seborama/govcr) - **Star : 78** **最近提交 : 2019-06-06**  HTTP mock : 离线测试时记录和重放浏览器的动作
    * [hoverfly](https://github.com/SpectoLabs/hoverfly) - **Star : 1407** **最近提交 : 2019-06-26**  使用可扩展中间件和易于使用的CLI记录和模拟REST/SOAP api的HTTP(S)代理。![star > 1000][Silver]
    * [httpmock](https://github.com/jarcoal/httpmock) - **Star : 555** **最近提交 : 2019-05-03**  轻松模拟来自外部资源的HTTP响应。![star > 100][Bronze]
    * [minimock](https://github.com/gojuno/minimock) - **Star : 193** **最近提交 : 2019-06-18**  Go接口的模拟生成器。![star > 100][Bronze]
    * [mockhttp](https://github.com/tv42/mockhttp) - **Star : 22** **最近提交 : 2014-10-30**  Go http.ResponseWriter的模拟对象。

* Fuzzing and delta-debugging/reducing/shrinking.
    * [go-fuzz](https://github.com/dvyukov/go-fuzz) - **Star : 2836** **最近提交 : 2019-05-16**  随机测试系统。![star > 1000][Silver]
    * [gofuzz](https://github.com/google/gofuzz) - **Star : 518** **最近提交 : 2019-04-09**  用于生成随机值来初始化 Go 语言对象的库![star > 100][Bronze]
    * [Tavor](https://github.com/zimmski/tavor) - **Star : 208** **最近提交 : 2018-11-01**  通用模糊测试框架![star > 100][Bronze]

* Selenium and browser control tools.
    * [cdp](https://github.com/mafredri/cdp) - **Star : 343** **最近提交 : 2019-06-16**  用于Chrome调试协议的类型安全绑定，可与实现该协议的浏览器或其他调试目标一起使用。![star > 100][Bronze]
    * [chromedp](https://github.com/knq/chromedp) - **Star : 3384** **最近提交 : 2019-07-01**  用于驱动和测试 Chrome, Safari, Edge, Android Webviews, 以及其他支持 Chrome 调试协议的产品![star > 1000][Silver]
    * [ggr](https://github.com/aerokube/ggr) - **Star : 208** **最近提交 : 2019-06-24**  一个轻量级服务器，可以将 Selenium Wedriver 的请求路由或代理到多个 Selenium hubs![star > 100][Bronze]
    * [selenoid](https://github.com/aerokube/selenoid) - **Star : 1174** **最近提交 : 2019-06-25**  Selenium hub 服务器的替代品，在容器中启动浏览器![star > 1000][Silver]

* Fail injection
    * [failpoint](https://github.com/pingcap/failpoint) - **Star : 365** **最近提交 : 2019-06-30**  为Golang实现[failpoints](http://www.freebsd.org/cgi/man.cgi?query=fail)。![star > 100][Bronze]
...
* Specific Formats
    ...
    * [blackfriday](https://github.com/russross/blackfriday) - **Star : 3795** **最近提交 : 2019-06-29**  Markdown 解析器![star > 1000][Silver]
    * [bluemonday](https://github.com/microcosm-cc/bluemonday) - **Star : 1212** **最近提交 : 2019-03-15**  HTML 清理工具![star > 1000][Silver]
    * [codetree](https://github.com/aerogo/codetree) - **Star : 6** **最近提交 : 2019-06-09**  解析缩进代码(python、pixy、scarlet等)并返回树结构。
    * [colly](https://github.com/asciimoo/colly) - **Star : 8050** **最近提交 : 2019-06-22**  快速和优雅的 Scraping 框架。![star > 5000][Gold]
    * [commonregex](https://github.com/mingrammer/commonregex) - **Star : 545** **最近提交 : 2018-12-08**  一组用于Go的公共正则表达式。![star > 100][Bronze]
    * [dataflowkit](https://github.com/slotix/dataflowkit) - **Star : 276** **最近提交 : 2019-04-11**  Web抓取框架将网站转换为结构化数据。![star > 100][Bronze]
    ...
    * [go-humanize](https://github.com/dustin/go-humanize) - **Star : 1847** **最近提交 : 2019-01-09**  格式化程序，用于将时间、数字和内存大小转换为可读格式。![star > 1000][Silver]
    * [go-nmea](https://github.com/adrianmo/go-nmea) - **Star : 90** **最近提交 : 2019-06-03**  用于Go语言的NMEA解析器库。
    * [go-runewidth](https://github.com/mattn/go-runewidth) - **Star : 207** **最近提交 : 2018-12-18**  函数获取字符或字符串的固定宽度。![star > 100][Bronze]
    * [go-slugify](https://github.com/mozillazg/go-slugify) - **Star : 27** **最近提交 : 2016-08-13**  生成漂亮的固定链接地址（slug），支持多种语言
    * [go-toml](https://github.com/pelletier/go-toml) - **Star : 588** **最近提交 : 2019-05-30**  使用带有查询支持和方便的cli工具的TOML格式库。![star > 100][Bronze]
    ...
    * [gofeed](https://github.com/mmcdole/gofeed) - **Star : 1077** **最近提交 : 2019-04-20**  在Go中解析RSS和Atom feeds。![star > 1000][Silver]
    * [gographviz](https://github.com/awalterschulze/gographviz) - **Star : 284** **最近提交 : 2019-06-21**  解析Graphviz DOT语言。![star > 100][Bronze]
    ...
    * [goq](https://github.com/andrewstuart/goq) - **Star : 141** **最近提交 : 2019-06-07**   声明式 HTML 编组，使用结构标签和 jQuery 语法 (使用 GoQuery).![star > 100][Bronze]
    * [GoQuery](https://github.com/PuerkitoBio/goquery) - **Star : 7412** **最近提交 : 2019-04-23**  GoQuery 为 Go 语言带来了一组类似 jQuery 的语法和功能![star > 5000][Gold]
    * [goregen](https://github.com/zach-klippenstein/goregen) - **Star : 35** **最近提交 : 2016-03-04**  根据正则表达式生成随机字符串
    * [gotext](https://github.com/leonelquinteros/gotext) - **Star : 228** **最近提交 : 2019-03-07**  GNU gettext 工具![star > 100][Bronze]
    * [guesslanguage](https://github.com/endeveit/guesslanguage) - **Star : 44** **最近提交 : 2017-11-08**  通过一个 unicode 文本来猜测该文本使用的语言
    * [htmlquery](https://github.com/antchfx/htmlquery) - **Star : 115** **最近提交 : 2019-02-08**  用于HTML的XPath查询包，允许您通过XPath表达式从HTML文档中提取数据或求值。![star > 100][Bronze]
    * [inject](https://github.com/facebookgo/inject) - **Star : 1129** **最近提交 : 2019-01-14**  包注入提供了一个基于反射的注入器。![star > 1000][Silver]
    * [ltsv](https://github.com/Wing924/ltsv) - **Star : 2** **最近提交 : 2019-06-23**  用于Go的高性能[LTSV(标签为Tab Separeted Value)](http://ltsv.org/)阅读器。
    * [mxj](https://github.com/clbanning/mxj) - **Star : 323** **最近提交 : 2019-06-13**  将XML编码/解码为JSON或map[string]接口{};使用点符号路径和通配符提取值。替换x2j和j2x包。![star > 100][Bronze]
    * [sdp](https://github.com/gortc/sdp) - **Star : 66** **最近提交 : 2019-03-23**  SDP:会话描述协议[[RFC 4566](https://tools.ietf.org/html/rfc4566)]。
    * [sh](https://github.com/mvdan/sh) - **Star : 1915** **最近提交 : 2019-07-01**  Shell解析器和格式化工具。![star > 1000][Silver]
    * [slug](https://github.com/gosimple/slug) - **Star : 365** **最近提交 : 2019-06-12**  URL 友好的 slug 化工具，支持多种语言![star > 100][Bronze]
    ...
    * [toml](https://github.com/BurntSushi/toml) - **Star : 2707** **最近提交 : 2019-03-27**  TOML配置格式(带反射的编码器/解码器)。![star > 1000][Silver]
* Utility
    * [gofuckyourself](https://github.com/JoshuaDoes/gofuckyourself) - **Star : 15** **最近提交 : 2018-11-18**  一个基于 sanitization 的 Go 敏感词过滤器。
    * [gotabulate](https://github.com/bndr/gotabulate) - **Star : 198** **最近提交 : 2017-03-15**  使用 Go 语言简单、美观的打印表格数据![star > 100][Bronze]
    ...
    * [radix](https://github.com/yourbasic/radix) - **Star : 141** **最近提交 : 2018-03-08**  快速字符串排序算法。![star > 100][Bronze]
    ...
    * [xurls](https://github.com/mvdan/xurls) - **Star : 454** **最近提交 : 2019-05-13**  从文本中提取url。![star > 100][Bronze]
...
* [anaconda](https://github.com/ChimeraCoder/anaconda) - **Star : 983** **最近提交 : 2019-06-10**   Twitter 1.1 API 的 go 语言客户端![star > 100][Bronze]
* [aws-sdk-go](https://github.com/aws/aws-sdk-go) - **Star : 4917** **最近提交 : 2019-06-29**  AWS 提供的官方go语言 SDK![star > 1000][Silver]
...
* [discordgo](https://github.com/bwmarrin/discordgo) - **Star : 930** **最近提交 : 2019-07-01**   Discord Chat API的客户端。![star > 100][Bronze]
* [ethrpc](https://github.com/onrik/ethrpc) - **Star : 164** **最近提交 : 2019-03-05**   Ethereum JSON RPC API的客户端。![star > 100][Bronze]
* [facebook](https://github.com/huandu/facebook) - **Star : 764** **最近提交 : 2019-06-13**  支持 Facebook Graph API 的库![star > 100][Bronze]
...
* [github](https://github.com/google/go-github) - **Star : 4676** **最近提交 : 2019-07-01**  访问GitHub REST API v3的库。![star > 1000][Silver]
* [githubql](https://github.com/shurcooL/githubql) - **Star : 479** **最近提交 : 2019-06-25**  访问GitHub GraphQL API v4的库。![star > 100][Bronze]
...
* [go-jira](https://github.com/andygrunwald/go-jira) - **Star : 549** **最近提交 : 2019-06-22**   Go [Atlassian JIRA]的客户端库(https://www.atlassian.com/software/jira)![star > 100][Bronze]
* [go-marathon](https://github.com/gambol99/go-marathon) - **Star : 188** **最近提交 : 2019-05-14**   用于和 Mesosphere's Marathon PAAS 交互的 Go 语言库![star > 100][Bronze]
...
* [go-twitter](https://github.com/dghubble/go-twitter) - **Star : 688** **最近提交 : 2019-05-16**   Twitter v1.1 api 的客户端。。![star > 100][Bronze]
...
* [google](https://github.com/google/google-api-go-client) - **Star : 1890** **最近提交 : 2019-06-30**  为Go自动生成谷歌api。![star > 1000][Silver]
* [google-analytics](https://github.com/chonthu/go-google-analytics) - **Star : 12** **最近提交 : 2015-06-09**  简单的包装，方便的谷歌分析报告。
* [google-cloud](https://github.com/GoogleCloudPlatform/gcloud-golang) - **Star : 1722** **最近提交 : 2019-06-29**  谷歌云api Go 客户端库。![star > 1000][Silver]
...
* [gostorm](https://github.com/jsgilmore/gostorm) - **Star : 119** **最近提交 : 2017-10-09**  GoStorm是一个Go库，它实现了编写Storm spout和bolt所需的通信协议，这些协议用于与Storm shell通信。![star > 100][Bronze]
* [hipchat](https://github.com/andybons/hipchat) - **Star : 109** **最近提交 : 2016-03-25**  这个项目为Hipchat API实现了一个golang客户端库。![star > 100][Bronze]
* [hipchat (xmpp)](https://github.com/daneharrigan/hipchat) - **Star : 114** **最近提交 : 2017-06-12**  一个用于通过XMPP与HipChat通信的golang包。![star > 100][Bronze]
* [igdb](https://github.com/Henry-Sarabia/igdb) - **Star : 52** **最近提交 : 2019-06-15**  [Internet Game Database API](https://api.igdb.com/) 客户端。
* [Medium](https://github.com/Medium/medium-sdk-go) - **Star : 116** **最近提交 : 2018-10-27**  Medium的OAuth2 API 客户端。![star > 100][Bronze]
* [megos](https://github.com/andygrunwald/megos) - **Star : 57** **最近提交 : 2018-04-24**  用于访问[Apache Mesos](http://mesos.apache.org/)集群的客户端库。
* [minio-go](https://github.com/minio/minio-go) - **Star : 704** **最近提交 : 2019-06-27**  用于Amazon S3兼容云存储的Minio Go库。![star > 100][Bronze]
...
* [paypal](https://github.com/logpacker/PayPal-Go-SDK) - **Star : 296** **最近提交 : 2019-06-29**  PayPal支付API的包装器。![star > 100][Bronze]
...
* [slack](https://github.com/nlopes/slack) - **Star : 2338** **最近提交 : 2019-06-26**  Slack API。![star > 1000][Silver]
...
* [stripe](https://github.com/stripe/stripe-go) - **Star : 912** **最近提交 : 2019-06-29**   Stripe API 的 Go 语言客户端![star > 100][Bronze]
...
* [webhooks](https://github.com/go-playground/webhooks) - **Star : 335** **最近提交 : 2019-06-20**  GitHub 和 Bitbucket 的Webhook接收器。![star > 100][Bronze]
...
* [apm](https://github.com/topfreegames/apm) - **Star : 127** **最近提交 : 2016-11-25**  Go 语言进程管理工具具有HTTP API.。![star > 100][Bronze]
...
* [boilr](https://github.com/tmrts/boilr) - **Star : 921** **最近提交 : 2018-07-25**  非常快的CLI工具，用于从样板模板创建项目。![star > 100][Bronze]
* [chyle](https://github.com/antham/chyle) - **Star : 107** **最近提交 : 2019-07-01**  使用具有多种配置可能性的git存储库生成变更日志。![star > 100][Bronze]
* [circuit](https://github.com/cep21/circuit) - **Star : 315** **最近提交 : 2019-06-27**  一个高效和功能齐全的 类似 Hystrix Go 实现断路器模式。![star > 100][Bronze]
* [circuitbreaker](https://github.com/rubyist/circuitbreaker) - **Star : 776** **最近提交 : 2019-01-30**  接通断路器。![star > 100][Bronze]
* [clockwork](https://github.com/jonboulle/clockwork) - **Star : 217** **最近提交 : 2019-01-14**  一个简单的假 clock 。![star > 100][Bronze]
...
* [ctop](https://github.com/bcicen/ctop) - **Star : 8626** **最近提交 : 2019-06-30**  [Top-like](http://ctop.sh)接口(例如htop)， 用于容器数据收集。![star > 5000][Gold]
...
* [Death](https://github.com/vrecan/death) - **Star : 132** **最近提交 : 2018-10-23**  利用信号管理应用程序的关闭。![star > 100][Bronze]
* [Deepcopier](https://github.com/ulule/deepcopier) - **Star : 201** **最近提交 : 2017-11-07**  结构体拷贝![star > 100][Bronze]
* [delve](https://github.com/derekparker/delve) - **Star : 11684** **最近提交 : 2019-07-01**  Go 语言调试器![star > 5000][Gold]
* [dlog](https://github.com/kirillDanshin/dlog) - **Star : 15** **最近提交 : 2017-07-28**  编译时控制的日志，让你的 release 包变得更小而不需移除 debug 调用。
* [ergo](https://github.com/cristianoliveira/ergo) - **Star : 307** **最近提交 : 2018-11-29**  管理运行在不同端口上的多个本地服务变得很容易。![star > 100][Bronze]
...
* [filetype](https://github.com/h2non/filetype) - **Star : 923** **最近提交 : 2019-05-15**  通过数字签名来推测文件类型。![star > 100][Bronze]
...
* [fzf](https://github.com/junegunn/fzf) - **Star : 22371** **最近提交 : 2019-06-25**  用Go编写的命令行模糊查找器。![star > 5000][Gold]
...
* [git-time-metric](https://github.com/git-time-metric/gtm) - **Star : 709** **最近提交 : 2019-06-30**  git-time-metric - 。![star > 100][Bronze]
* [go-astitodo](https://github.com/asticode/go-astitodo) - **Star : 46** **最近提交 : 2018-09-22**  解析你 Go 语言代码中的 TODOs（待办事项）。
* [go-bind-plugin](https://github.com/wendigo/go-bind-plugin) - **Star : 159** **最近提交 : 2017-08-27**  Go:generate 工具，用于构建 Go 语言插件(1.8 only)，并对导出的符号进行包装。![star > 100][Bronze]
* [go-bsdiff](https://github.com/gabstv/go-bsdiff) - **Star : 79** **最近提交 : 2019-03-21**  纯Go bsdiff和bspatch库和CLI工具。
* [go-dry](https://github.com/ungerik/go-dry) - **Star : 432** **最近提交 : 2018-04-11**  DRY(don't repeat yourself)库。![star > 100][Bronze]
* [go-funk](https://github.com/thoas/go-funk) - **Star : 997** **最近提交 : 2019-05-03**  现代 Go 语言工具库，提供了很多有用的工具 (map, find, contains, filter, chunk, reverse, ...)![star > 100][Bronze]
...
* [go-rate](https://github.com/beefsack/go-rate) - **Star : 292** **最近提交 : 2018-04-09**   Go 限速器。![star > 100][Bronze]
* [go-sitemap-generator](https://github.com/ikeikeikeike/go-sitemap-generator) - **Star : 103** **最近提交 : 2019-06-04**  用Go编写的XML站点地图生成器。![star > 100][Bronze]
* [go-torch](https://github.com/uber/go-torch) - **Star : 3624** **最近提交 : 2018-11-07**  为 Go 语言程序生成火焰图。![star > 1000][Silver]
* [go-trigger](https://github.com/sadlil/go-trigger) - **Star : 181** **最近提交 : 2017-03-29**  Go 语言全局事件触发器，通过 id 和触发器，在程序的任何地方注册事件。![star > 100][Bronze]
* [goback](https://github.com/carlescere/goback) - **Star : 39** **最近提交 : 2018-02-08**   一个 Go 语言的简单的指数补偿包。
* [godaemon](https://github.com/VividCortex/godaemon) - **Star : 401** **最近提交 : 2019-03-21**  用于编写守护进程的工具![star > 100][Bronze]
* [godropbox](https://github.com/dropbox/godropbox) - **Star : 3730** **最近提交 : 2019-05-01**  用于编写 Go 语言服务／应用的库，来自 Dropbox.。![star > 1000][Silver]
* [gohper](https://github.com/cosiner/gohper) - **Star : 248** **最近提交 : 2017-08-12**  多种能够帮助你进行软件开发的工具和模块。![star > 100][Bronze]
...
* [gopencils](https://github.com/bndr/gopencils) - **Star : 423** **最近提交 : 2019-02-18**  小而简单的包，可以轻松地使用REST api。![star > 100][Bronze]
...
* [goreleaser](https://github.com/goreleaser/goreleaser) - **Star : 4331** **最近提交 : 2019-06-30**  尽可能快速的发布 Go 语言二进制文件。![star > 1000][Silver]
* [goreporter](https://github.com/wgliang/goreporter) - **Star : 2457** **最近提交 : 2018-10-28**  进行代码静态分析，单元测试，代码检视并生成代码质量报告的工具![star > 1000][Silver]
...
* [gotenv](https://github.com/subosito/gotenv) - **Star : 136** **最近提交 : 2018-06-06**  从 `.env` 或者任何 `io.Reader`。![star > 100][Bronze]
* [gpath](https://github.com/tenntenn/gpath) - **Star : 25** **最近提交 : 2017-06-04**   用于简化结构体域访问的库。
* [gubrak](https://github.com/novalagung/gubrak) - **Star : 127** **最近提交 : 2019-03-16**  带有语法糖的Golang实用工具，就像lodash。![star > 100][Bronze]
* [handy](https://github.com/miguelpragier/handy) - **Star : 43** **最近提交 : 2019-06-12**  许多实用程序和帮助程序，如字符串处理程序/格式化程序和验证器。
* [htcat](https://github.com/htcat/htcat) - **Star : 480** **最近提交 : 2019-02-27**  并行及流水线的 HTTP GET 工具。![star > 100][Bronze]
* [hub](https://github.com/github/hub) - **Star : 16548** **最近提交 : 2019-06-29**  封装了 git 命令，提供了额外的功能用于在终端中和 Github 进行交互。![star > 5000][Gold]
* [hystrix-go](https://github.com/afex/hystrix-go) - **Star : 1943** **最近提交 : 2019-06-13**  实现 Hystrix 风格的、程序员预定义的 fallback 机制（熔断。![star > 1000][Silver]
* [immortal](https://github.com/immortal/immortal) - **Star : 598** **最近提交 : 2019-03-08**  \*nix 跨平台 (与操作系统无关的)监控程序。![star > 100][Bronze]
* [intrinsic](https://github.com/mengzhuo/intrinsic) - **Star : 39** **最近提交 : 2017-06-23**  不需要编写任何汇编代码就能使用 x86 SIMD。
* [jump](https://github.com/gsamokovarov/jump) - **Star : 639** **最近提交 : 2019-06-20**  通过学习你的习惯，可以帮助你更快地导航。![star > 100][Bronze]
* [koazee](https://github.com/wesovilabs/koazee) - **Star : 276** **最近提交 : 2019-03-05**  库的灵感来自于延迟计算和函数式编程，从而减少了使用数组的麻烦。![star > 100][Bronze]
* [lrserver](https://github.com/jaschaephraim/lrserver) - **Star : 99** **最近提交 : 2017-11-30**  LiveReload 服务器。
* [mc](https://github.com/minio/mc) - **Star : 1064** **最近提交 : 2019-06-29**  Minio Client 提供了一组工具，用于操作 Amazon S3 兼容云存储和文件系统。![star > 1000][Silver]
* [mergo](https://github.com/imdario/mergo) - **Star : 821** **最近提交 : 2019-06-15**  用于将结构体和map合并进 Go 语言的工具。对于配置默认值，避免杂乱的if语句很有帮助。![star > 100][Bronze]
...
* [minify](https://github.com/tdewolff/minify) - **Star : 1833** **最近提交 : 2019-06-18**  用于HTML、CSS、JS、XML、JSON和SVG文件格式的快速缩小器。![star > 1000][Silver]
* [minquery](https://github.com/icza/minquery) - **Star : 50** **最近提交 : 2018-10-21**  MongoDB / mgo.v2, 支持高效分页查询(用于继续列出我们停止的文档的游标)。
* [mmake](https://github.com/tj/mmake) - **Star : 1450** **最近提交 : 2019-06-17**  现代 Make 工具![star > 1000][Silver]
* [moldova](https://github.com/StabbyCutyou/moldova) - **Star : 148** **最近提交 : 2017-09-04**  基于输入目标生成随机数据的工具![star > 100][Bronze]
* [mole](https://github.com/davrodpin/mole) - **Star : 1290** **最近提交 : 2019-07-01**  cli应用程序可以轻松创建ssh隧道。![star > 1000][Silver]
...
* [panicparse](https://github.com/maruel/panicparse) - **Star : 2073** **最近提交 : 2019-07-01**  将类似的协程分组并对调用栈进行着色![star > 1000][Silver]
* [peco](https://github.com/peco/peco) - **Star : 5404** **最近提交 : 2019-06-12**  简单的交互过滤工具。![star > 5000][Gold]
...
* [profile](https://github.com/pkg/profile) - **Star : 977** **最近提交 : 2019-03-24**  Go的简单分析支持包。![star > 100][Bronze]
* [rclient](https://github.com/zpatrick/rclient) - **Star : 26** **最近提交 : 2018-08-29**  可读、灵活、易于使用的REST api客户端。
* [realize](https://github.com/tockins/realize) - **Star : 3082** **最近提交 : 2019-05-05**  Go 语言构建系统，可以监控文件变化并重新加载。运行，构建，监控文件并支持自定义路径。![star > 1000][Silver]
* [repeat](https://github.com/ssgreg/repeat) - **Star : 56** **最近提交 : 2019-01-13**  执行不同的后 backoff 策略，这对重新尝试操作和心跳非常有用。
* [request](https://github.com/mozillazg/request) - **Star : 353** **最近提交 : 2018-06-14**  Go 语言版的 HTTP Requests for Humans™.。![star > 100][Bronze]
* [rerate](https://github.com/abo/rerate) - **Star : 12** **最近提交 : 2017-03-28**  基于 Redis 的速率计数器和限速器
* [rerun](https://github.com/ivpusic/rerun) - **Star : 153** **最近提交 : 2018-03-23**  当源代码发生更改时，重新编译和重新运行go应用程序。![star > 100][Bronze]
* [resty](https://github.com/go-resty/resty) - **Star : 1811** **最近提交 : 2019-06-19**  简单的 HTTP 和 REST 客户端，受到 Ruby rest-client 的启发。![star > 1000][Silver]
* [retry](https://github.com/kamilsk/retry) - **Star : 139** **最近提交 : 2019-05-30**  基于上下文的功能机制，反复执行命令直到成功。![star > 100][Bronze]
...
* [robustly](https://github.com/VividCortex/robustly) - **Star : 133** **最近提交 : 2018-03-24**  有弹性的执行函数，遇到错误时捕获并重新运行。![star > 100][Bronze]
* [scan](https://github.com/blockloop/scan) - **Star : 11** **最近提交 : 2019-06-20**  扫描golang的sql。行直接指向结构、片或基本类型。
* [serve](https://github.com/syntaqx/serve) - **Star : 190** **最近提交 : 2019-03-30**  任何您需要的静态http服务器。![star > 100][Bronze]
...
* [spinner](https://github.com/briandowns/spinner) - **Star : 763** **最近提交 : 2019-06-11**   一个 Go 语言软件包，提供多种选项，方便在终端中创建加载动画。![star > 100][Bronze]
* [sqlx](https://github.com/jmoiron/sqlx) - **Star : 6558** **最近提交 : 2019-06-20**  为内建的数据库/sql 软件包提供一组扩展。![star > 5000][Gold]
* [sslice](https://github.com/yaa110/sslice) - **Star : 2** **最近提交 : 2018-11-17**  创建一个总是排序的切片。
* [Storm](https://github.com/asdine/storm) - **Star : 1332** **最近提交 : 2019-04-18**  一个简单又强大的用于 BoltDB 的工具![star > 1000][Silver]
* [structs](https://github.com/PumpkinSeed/structs) - **Star : 12** **最近提交 : 2017-10-23**  简单来讲就是 "Make" 的替代品。
* [Task](https://github.com/go-task/task) - **Star : 1856** **最近提交 : 2019-06-29**  简单的“Go”的选择。![star > 1000][Silver]
...
* [usql](https://github.com/knq/usql) - **Star : 4649** **最近提交 : 2019-04-28**  usql 是一个通用的命令行接口，用于操作 sql 数据库。![star > 1000][Silver]
* [util](https://github.com/shomali11/util) - **Star : 131** **最近提交 : 2019-06-08**  有用实用函数的集合。(字符串，并发，操作，…)![star > 100][Bronze]
* [wuzz](https://github.com/asciimoo/wuzz) - **Star : 8190** **最近提交 : 2018-12-07**  用于HTTP检查的交互式cli工具。![star > 5000][Gold]
...
* [ulid](https://github.com/oklog/ulid) - **Star : 1652** **最近提交 : 2019-06-03**  实现了ULID(普遍唯一的词典分类标识符)。![star > 1000][Silver]
* [uuid](https://github.com/agext/uuid) - **Star : 10** **最近提交 : 2019-02-23**  使用快速或加密质量的随机节点标识符生成、编码和解码UUIDs v1。
* [uuid](https://github.com/gofrs/uuid) - **Star : 547** **最近提交 : 2019-06-23**  通用唯一标识符(UUID)的实现。支持uuid的创建和解析。积极维护satori uuid的fork。![star > 100][Bronze]
* [wuid](https://github.com/edwingeng/wuid) - **Star : 266** **最近提交 : 2019-06-01**  一个非常快的唯一数字生成器，比UUID快10-135倍。![star > 100][Bronze]
...
* [govalidator](https://github.com/asaskevich/govalidator) - **Star : 3472** **最近提交 : 2019-05-10**  用于字符串，数字，切片和结构的验证器和sanitizers。![star > 1000][Silver]
* [govalidator](https://github.com/thedevsaddam/govalidator) - **Star : 687** **最近提交 : 2019-06-21**  用简单的规则验证Golang请求数据。深受Laravel请求验证的启发。![star > 100][Bronze]
* [jio](https://github.com/faceair/jio) - **Star : 21** **最近提交 : 2019-05-29**  jio是一个json模式验证器，类似于[joi](https://github.com/hapijs/joi)。
* [ozzo-validation](https://github.com/go-ozzo/ozzo-validation) - **Star : 1006** **最近提交 : 2019-05-24**  支持各种数据类型(结构、字符串、映射、片等)的验证，使用可配置和可扩展的验证规则，这些规则在通常的代码构造中指定，而不是在结构标签中指定。![star > 1000][Silver]
...
* [validator](https://github.com/go-playground/validator) - **Star : 3282** **最近提交 : 2019-06-14**   Go 结构体及域验证，包括：跨域、跨结构体, Map, 切片和数组。![star > 1000][Silver]
...
* [git2go](https://github.com/libgit2/git2go) - **Star : 1338** **最近提交 : 2019-06-20**   libgit2 的 Go 语言接口。![star > 1000][Silver]
* [go-git](https://github.com/src-d/go-git) - **Star : 4098** **最近提交 : 2019-07-01**  纯Go中高度可扩展的Git实现。![star > 1000][Silver]
* [go-vcs](https://github.com/sourcegraph/go-vcs) - **Star : 69** **最近提交 : 2019-06-19**  在Go中操作和检查VCS存储库。
* [hercules](https://github.com/src-d/hercules) - **Star : 492** **最近提交 : 2019-06-21**  从Git存储库历史中获得高级见解。![star > 100][Bronze]
...
* [gmf](https://github.com/3d0c/gmf) - **Star : 508** **最近提交 : 2019-05-31**   FFmpeg av\* 库的 Go 语言接口。![star > 100][Bronze]
* [go-astisub](https://github.com/asticode/go-astisub) - **Star : 162** **最近提交 : 2019-05-25**  使用 Go 语言操作字幕(.srt, .stl, .ttml, .webvtt, .ssa/.ass, teletext, .smi, etc.)。![star > 100][Bronze]
* [go-astits](https://github.com/asticode/go-astits) - **Star : 256** **最近提交 : 2019-05-09**  在GO中解析和演示MPEG传输流(.ts)。![star > 100][Bronze]
* [go-m3u8](https://github.com/quangngotan95/go-m3u8) - **Star : 36** **最近提交 : 2019-04-26**  苹果m3u8播放列表的解析器和生成器库。
* [goav](https://github.com/giorgisio/goav) - **Star : 748** **最近提交 : 2019-05-28**  FFmpeg的Comphrensive。![star > 100][Bronze]
* [gst](https://github.com/ziutek/gst) - **Star : 153** **最近提交 : 2018-07-25**   GStreamer的Go工具。![star > 100][Bronze]
...
* [Aero](https://github.com/aerogo/aero) - **Star : 152** **最近提交 : 2019-06-17**  高性能的Go web框架，在Lighthouse中达到最高分。![star > 100][Bronze]
* [Air](https://github.com/aofei/air) - **Star : 512** **最近提交 : 2019-06-19**  一个理想的精细化的Go web框架。![star > 100][Bronze]
* [Banjo](https://github.com/nsheremet/banjo) - **Star : 7** **最近提交 : 2018-02-01**  非常简单和快速的网络框架 Go 。
* [Beego](https://github.com/astaxie/beego) - **Star : 21008** **最近提交 : 2019-06-28**  beego是一种用于 Go 编程语言的开源高性能web框架。![star > 5000][Gold]
* [Buffalo](http://gobuffalo.io) - 为 Go 语言带来堪比 Rails 的高生产效率!
* [Echo](https://github.com/labstack/echo) - **Star : 14331** **最近提交 : 2019-07-01**  高性能、极简的Go web框架。![star > 5000][Gold]
* [Fireball](https://github.com/zpatrick/fireball) - **Star : 48** **最近提交 : 2018-10-04**  感觉更加自然的 web 框架。
* [Gem](https://github.com/go-gem/gem) - **Star : 153** **最近提交 : 2017-03-19**  简单快速的web框架，对REST API友好。![star > 100][Bronze]
* [Gin](https://github.com/gin-gonic/gin) - **Star : 28677** **最近提交 : 2019-06-30**  Gin是一个用Go编写的web框架!它具有一个类似于martini的API，性能更好，速度快40倍。![star > 5000][Gold]
* [Gizmo](https://github.com/NYTimes/gizmo) - **Star : 2811** **最近提交 : 2019-06-12**  《纽约时报》使用的微服务工具包。![star > 1000][Silver]
* [go-json-rest](https://github.com/ant0ine/go-json-rest) - **Star : 3317** **最近提交 : 2019-02-19**  设置RESTful JSON API的快速简便方法。![star > 1000][Silver]
* [go-rest](https://github.com/ungerik/go-rest) - **Star : 115** **最近提交 : 2017-01-20**  小型的 REST 框架。![star > 100][Bronze]
* [Goa](https://github.com/goadesign/goa) - **Star : 3457** **最近提交 : 2019-07-01**  Goa为在Go中开发远程api和微服务提供了一种全面的方法。![star > 1000][Silver]
* [Golax](https://github.com/fulldump/golax) - **Star : 71** **最近提交 : 2018-06-04**  一个非Sinatra快速HTTP框架，支持谷歌自定义方法、深度拦截器、递归等。
* [Golf](https://github.com/dinever/golf) - **Star : 235** **最近提交 : 2017-02-25**  Golf 是一个快速、简单、轻量级的 Go 语言微型 web 框架。具有强大的功能且没有标准库以外的依赖。![star > 100][Bronze]
* [Gondola](https://github.com/rainycape/gondola) - **Star : 315** **最近提交 : 2019-02-19**  web框架写的网站越快越好。![star > 100][Bronze]
* [gongular](https://github.com/mustafaakin/gongular) - **Star : 415** **最近提交 : 2019-02-19**   快速 Go web 框架，支持输入映射／验证以及依赖注入。![star > 100][Bronze]
* [hiboot](https://github.com/hidevopsio/hiboot) - **Star : 80** **最近提交 : 2019-04-30**  hiboot是一个高性能的web应用程序框架，支持自动配置和依赖注入。
* [Macaron](https://github.com/go-macaron/macaron) - **Star : 2782** **最近提交 : 2019-04-24**  Macaron 是一个高效的模块化设计的web框架![star > 1000][Silver]
* [mango](https://github.com/paulbellamy/mango) - **Star : 339** **最近提交 : 2017-10-17**  ManGo 是一个模块化 web 应用框架，受到 Rack 和 PEP333 的启发。![star > 100][Bronze]
* [Microservice](https://github.com/claygod/microservice) - **Star : 56** **最近提交 : 2019-06-03**  创建微服务的框架，用Golang编写。
* [neo](https://github.com/ivpusic/neo) - **Star : 392** **最近提交 : 2017-12-30**  Neo是一个非常简单且快速的Web框架API。![star > 100][Bronze]
* [nio](https://github.com/go-nio/nio) - **Star : 21** **最近提交 : 2019-02-23**  现代的、最小的和高效的Go HTTP框架。
* [patron](https://github.com/beatlabs/patron) - **Star : 20** **最近提交 : 2019-07-01**  Patron是一个遵循最佳云实践的微服务框架，专注于提升开发效率。
...
* [Revel](https://github.com/revel/revel) - **Star : 11167** **最近提交 : 2019-05-19**  用于Go语言的高效web框架。![star > 5000][Gold]
...
* [tango](https://github.com/lunny/tango) - **Star : 814** **最近提交 : 2019-05-17**  微型的、支持插件的 web 框架。![star > 100][Bronze]
* [tigertonic](https://github.com/rcrowley/go-tigertonic) - **Star : 998** **最近提交 : 2018-07-24**  用于构建 JSON web 服务的 Go 语言框架，受到 Dropwizard 的启发。![star > 100][Bronze]
* [traffic](https://github.com/pilu/traffic) - **Star : 518** **最近提交 : 2015-11-27**  Sinatra启发了regexp/pattern mux和用于Go的web框架。![star > 100][Bronze]
* [uAdmin](https://github.com/uadmin/uadmin) - **Star : 46** **最近提交 : 2019-06-24**  受到 Sinatra 启发的 Go 语言 web 框架。
* [utron](https://github.com/gernest/utron) - **Star : 2139** **最近提交 : 2018-10-29**  Go(Golang)的轻量级MVC框架。![star > 1000][Silver]
...
* [CORS](https://github.com/rs/cors) - **Star : 1175** **最近提交 : 2019-06-15**  轻松地向API添加CORS功能。![star > 1000][Silver]
* [formjson](https://github.com/rs/formjson) - **Star : 33** **最近提交 : 2015-12-17**  透明地将JSON输入作为标准表单POST处理。
* [go-server-timing](https://github.com/mitchellh/go-server-timing) - **Star : 743** **最近提交 : 2018-08-24**  添加/解析Server-Timing头。![star > 100][Bronze]
* [Limiter](https://github.com/ulule/limiter) - **Star : 760** **最近提交 : 2019-06-17**  简单的速度限制中间件。![star > 100][Bronze]
* [ln-paywall](https://github.com/philippgille/ln-paywall) - **Star : 86** **最近提交 : 2019-02-25**  使用Lightning Network(比特币)实现基于每个请求的api货币化中间件。
* [Tollbooth](https://github.com/didip/tollbooth) - **Star : 1208** **最近提交 : 2018-12-04**  限制速率的 HTTP 请求处理程序。![star > 1000][Silver]
* [XFF](https://github.com/sebest/xff) - **Star : 71** **最近提交 : 2019-04-11**  处理 X-Forwarded-For 头的中间件。

#### 用于创建HTTP中间件的库

* [alice](https://github.com/justinas/alice) - **Star : 1805** **最近提交 : 2018-11-11**  用于连接中间件的库，简单无痛苦。![star > 1000][Silver]
...
* [interpose](https://github.com/carbocation/interpose) - **Star : 290** **最近提交 : 2016-12-07**  golang的极简网络/http中间件。![star > 100][Bronze]
* [muxchain](https://github.com/stephens2424/muxchain) - **Star : 208** **最近提交 : 2019-03-20**  用于net/http的轻量级中间件。![star > 100][Bronze]
* [negroni](https://github.com/urfave/negroni) - **Star : 6276** **最近提交 : 2019-06-02**  符合语言习惯的 HTTP 中间件库。![star > 5000][Gold]
* [render](https://github.com/unrolled/render) - **Star : 1259** **最近提交 : 2019-03-25**  Go package用于方便地呈现JSON、XML和HTML模板响应。![star > 1000][Silver]
* [renderer](https://github.com/thedevsaddam/renderer) - **Star : 166** **最近提交 : 2019-03-11**  简单、轻量级和更快的响应(JSON、JSONP、XML、YAML、HTML、文件)。![star > 100][Bronze]
* [rye](https://github.com/InVisionApp/rye) - **Star : 92** **最近提交 : 2018-10-04**  支持JWT、CORS、Statsd和Go 1.7上下文的小型Go中间件库(带有罐装中间件)。
* [stats](https://github.com/thoas/stats) - **Star : 536** **最近提交 : 2019-04-08**  使用中间件来存储关于web应用程序的各种信息。![star > 100][Bronze]

### 路由器

* [alien](https://github.com/gernest/alien) - **Star : 105** **最近提交 : 2019-03-23**  轻量级和快速http路由器从外层空间。![star > 100][Bronze]
* [bellt](https://github.com/GuilhermeCaruso/bellt) - **Star : 37** **最近提交 : 2019-05-25**  一个简单的Go HTTP路由器。
* [Bone](https://github.com/go-zoo/bone) - **Star : 1219** **最近提交 : 2019-05-06**  闪电快速HTTP多路复用器。![star > 1000][Silver]
* [Bxog](https://github.com/claygod/Bxog) - **Star : 93** **最近提交 : 2018-12-28**  简单和快速的HTTP路由器 Go 。它可以处理不同难度、长度和嵌套的路径。他还知道如何根据接收到的参数创建URL。
* [chi](https://github.com/go-chi/chi) - **Star : 5849** **最近提交 : 2019-06-06**  小巧、快速、具有丰富表达力的 HTTP 路由，基于net/context.。![star > 5000][Gold]
* [fasthttprouter](https://github.com/buaazp/fasthttprouter) - **Star : 734** **最近提交 : 2019-04-25**  高性能路由器分叉从`httprouter`。第一个路由器适合`fasthttp`。![star > 100][Bronze]
* [FastRouter](https://github.com/razonyang/fastrouter) - **Star : 18** **最近提交 : 2017-11-03**  一个快速，灵活的HTTP路由器写在Go。
* [gocraft/web](https://github.com/gocraft/web) - **Star : 1390** **最近提交 : 2019-06-27**  Mux和中间件包在Go中。![star > 1000][Silver]
* [Goji](https://github.com/goji/goji) - **Star : 761** **最近提交 : 2019-02-18**  枸杞是一种简约的和灵活的与支持'net/context` HTTP请求多路复用器。![star > 100][Bronze]
...
* [gowww/router](https://github.com/gowww/router) - **Star : 158** **最近提交 : 2018-03-28**  超快的HTTP 路由，完全兼容 net/HTTP.Handler 接口.。![star > 100][Bronze]
* [httprouter](https://github.com/julienschmidt/httprouter) - **Star : 9482** **最近提交 : 2019-05-05**  高性能路由。使用这个库和标准http处理工具可以构建一个非常高性能大web框架。![star > 5000][Gold]
* [httptreemux](https://github.com/dimfeld/httptreemux) - **Star : 386** **最近提交 : 2018-12-19**  高速，灵活，基于树的 HTTP 路由。受到了 httprouter 的启发。![star > 100][Bronze]
* [lars](https://github.com/go-playground/lars) - **Star : 375** **最近提交 : 2019-05-16**  是一个轻量级、快速、可扩展、零分配的HTTP路由，用于创建定制化的框架。![star > 100][Bronze]
* [mux](https://github.com/gorilla/mux) - **Star : 9304** **最近提交 : 2019-06-30**  强大的URL路由器和调度器为golang。![star > 5000][Gold]
* [ozzo-routing](https://github.com/go-ozzo/ozzo-routing) - **Star : 358** **最近提交 : 2018-11-26**  一个非常快的Go (golang) HTTP路由器，支持正则表达式路由匹配。完全支持构建RESTful api。![star > 100][Bronze]
* [pure](https://github.com/go-playground/pure) - **Star : 83** **最近提交 : 2019-05-23**  是一个轻量级HTTP路由器，它坚持net/ HTTP“实现”的std。
* [Siesta](https://github.com/VividCortex/siesta) - **Star : 349** **最近提交 : 2019-05-23**  编写中间件和处理程序的可组合框架。![star > 100][Bronze]
* [vestigo](https://github.com/husobee/vestigo) - **Star : 250** **最近提交 : 2019-01-11**  高性能，独立，HTTP兼容的URL路由器的go web应用程序。![star > 100][Bronze]
...
* [xujiajun/gorouter](https://github.com/xujiajun/gorouter) - **Star : 444** **最近提交 : 2019-07-01**  一个简单和快速的HTTP路由器 Go 。![star > 100][Bronze]

## Windows

* [d3d9](https://github.com/gonutz/d3d9) - **Star : 86** **最近提交 : 2018-12-28**   Direct3D9 的 Go 语言接口。
* [go-ole](https://github.com/go-ole/go-ole) - **Star : 540** **最近提交 : 2019-03-05**  为 Go 语言实现的 Win32 OLE。![star > 100][Bronze]
...
* [xpath](https://github.com/antchfx/xpath) - **Star : 149** **最近提交 : 2019-06-18**  Go的XPath包。![star > 100][Bronze]
* [xquery](https://github.com/antchfx/xquery) - **Star : 145** **最近提交 : 2018-05-15**  XQuery允许您使用XPath表达式从HTML/XML文档中提取数据。![star > 100][Bronze]
* [zek](https://github.com/miku/zek) - **Star : 242** **最近提交 : 2019-06-11**  从XML生成Go结构。![star > 100][Bronze]
...
* [apicompat](https://github.com/bradleyfalzon/apicompat) - **Star : 165** **最近提交 : 2017-02-05**  检查 Go 项目最近的向下不兼容修改。![star > 100][Bronze]
* [dupl](https://github.com/mibk/dupl) - **Star : 167** **最近提交 : 2018-10-11**  用于代码克隆检测的工具。![star > 100][Bronze]
* [errcheck](https://github.com/kisielk/errcheck) - **Star : 1307** **最近提交 : 2019-06-29**  Errcheck是一个用于检查Go程序中未检查错误的程序。![star > 1000][Silver]
* [gcvis](https://github.com/davecheney/gcvis) - **Star : 912** **最近提交 : 2019-03-13**  实时可视化跟踪 GC 数据。![star > 100][Bronze]
* [go-checkstyle](https://github.com/qiniu/checkstyle) - **Star : 95** **最近提交 : 2019-03-07**  checkstyle是一个类似于java checkstyle的样式检查工具
* [go-cleanarch](https://github.com/roblaszczak/go-cleanarch) - **Star : 277** **最近提交 : 2018-05-14**  go-cleanarch 的创建是为了验证 Clean 体系结构规则，比如 Go 项目中的依赖关系。![star > 100][Bronze]
* [go-critic](https://github.com/go-critic/go-critic) - **Star : 551** **最近提交 : 2019-05-26**  源代码检查工具。![star > 100][Bronze]
* [go-mod-outdated](https://github.com/psampaz/go-mod-outdated) - **Star : 176** **最近提交 : 2019-05-06**  找出项目中过期的依赖项。![star > 100][Bronze]
* [go-outdated](https://github.com/firstrow/go-outdated) - **Star : 45** **最近提交 : 2019-01-15**  显示过期包的终端应用。
* [goast-viewer](https://github.com/yuroyoro/goast-viewer) - **Star : 367** **最近提交 : 2019-05-31**  基于 Web 的 Golang AST 可视化工具。![star > 100][Bronze]
...
* [GoLint](https://github.com/golang/lint) - **Star : 3096** **最近提交 : 2019-05-24**  Go 源码的 linter。![star > 1000][Silver]
...
* [gostatus](https://github.com/shurcooL/gostatus) - **Star : 241** **最近提交 : 2019-02-04**  用于显示包含 Go 包的存储库的状态的命令行工具，。![star > 100][Bronze]
* [lint](https://github.com/surullabs/lint) - **Star : 62** **最近提交 : 2018-10-28**  将 linters 作为测试的一部分。
* [php-parser](https://github.com/z7zmey/php-parser) - **Star : 614** **最近提交 : 2019-06-13**  用 Go 编写的 PHP 解析器。![star > 100][Bronze]
...
* [unconvert](https://github.com/mdempsky/unconvert) - **Star : 257** **最近提交 : 2019-03-26**  在源码中删除不必要的类型转换。![star > 100][Bronze]
...
* [go-mode](https://github.com/dominikh/go-mode.el) - **Star : 940** **最近提交 : 2019-04-24**  在 GNU/Emacs 支持 GO。![star > 100][Bronze]
* [go-plus](https://github.com/joefitzgerald/go-plus) - **Star : 1479** **最近提交 : 2019-06-26**  在 Atom 中添加自动完成，格式化，语法检查，高亮和审查。![star > 1000][Silver]
* [gocode](https://github.com/nsf/gocode) - **Star : 4713** **最近提交 : 2019-03-02**  Autocompletion daemon for the Go programming language.![star > 1000][Silver]
* [goprofiling](https://marketplace.visualstudio.com/items?itemName=MaxMedia.go-prof) - 在 VS Code 中支持 Go 的基准分析。
* [GoSublime](https://github.com/DisposaBoy/GoSublime) - **Star : 3215** **最近提交 : 2019-06-26**  包含了可为文本编辑器 SublimeText 3 提供代码自动填充和其他类似IDE的功能的 Golang IDE 插件集合。![star > 1000][Silver]
...
* [vim-go](https://github.com/fatih/vim-go) - **Star : 10658** **最近提交 : 2019-06-30**  Go 开发会用到的 Vim 插件。![star > 5000][Gold]
* [vscode-go](https://github.com/Microsoft/vscode-go) - **Star : 5006** **最近提交 : 2019-07-01**  Visual Studio代码的扩展(VS代码)，它提供了对Go语言的支持。![star > 5000][Gold]
* [Watch](https://github.com/eaburns/Watch) - **Star : 166** **最近提交 : 2018-03-25**  Runs a command in an acme win on file changes.![star > 100][Bronze]

## Go 生成工具

* [generic](https://github.com/usk81/generic) - **Star : 28** **最近提交 : 2019-03-28**  灵活的 Go 数据类型。
* [genny](https://github.com/cheekybits/genny) - **Star : 919** **最近提交 : 2019-06-11**  优雅的 Go 泛型。![star > 100][Bronze]
...
* [gotests](https://github.com/cweill/gotests) - **Star : 2122** **最近提交 : 2019-07-01**  从源代码生成测试用例。![star > 1000][Silver]
...
* [re2dfa](https://github.com/opennota/re2dfa) - **Star : 169** **最近提交 : 2018-09-11**  将正则表达式转换为有限状态机，并输出 Go 源代码。![star > 100][Bronze]
...
* [depth](https://github.com/KyleBanks/depth) - **Star : 369** **最近提交 : 2019-03-03**  通过分析导入，将包依赖关系树可视化输出。![star > 100][Bronze]
...
* [go-callvis](https://github.com/TrueFurby/go-callvis) - **Star : 1917** **最近提交 : 2019-01-15**  使用 dot format 可视化 Go 程序的调用图。![star > 1000][Silver]
* [go-pkg-complete](https://github.com/skelterjohn/go-pkg-complete) - **Star : 37** **最近提交 : 2017-11-17**  Bash completion for go and wgo。
* [go-swagger](https://github.com/go-swagger/go-swagger) - **Star : 3809** **最近提交 : 2019-07-01**  基于 Go 的Swagger 2.0实现。![star > 1000][Silver]
* [godbg](https://github.com/tylerwince/godbg) - **Star : 157** **最近提交 : 2019-04-20**  实现了 Rusts 的 dbg! 宏，可以方便的在开发过程中快速、容易地调试。![star > 100][Bronze]
* [OctoLinker](https://github.com/OctoLinker/browser-extension) - **Star : 3681** **最近提交 : 2019-06-27**  借助的 OctoLinker 浏览器扩展，可以高效的地浏览  GitHub go文件。![star > 1000][Silver]
* [richgo](https://github.com/kyoh86/richgo) - **Star : 374** **最近提交 : 2019-04-11**  用文本装饰丰富 go test 的输出。![star > 100][Bronze]
* [rts](https://github.com/galeone/rts) - **Star : 184** **最近提交 : 2016-12-07**  从服务器响应生成Go结构。![star > 100][Bronze]
...
* [aptly](https://github.com/smira/aptly) - **Star : 1723** **最近提交 : 2019-06-29**  Debian存储库管理工具。![star > 1000][Silver]
* [aurora](https://github.com/xuri/aurora) - **Star : 390** **最近提交 : 2019-06-23**  基于web的跨平台 Beanstalkd 队列服务器控制台。![star > 100][Bronze]
* [awsenv](https://github.com/soniah/awsenv) - **Star : 20** **最近提交 : 2018-07-17**  可以为 profile 加载Amazon (AWS)环境变量的轻量二进制文件。
* [Blast](https://github.com/dave/blast) - **Star : 168** **最近提交 : 2018-03-01**  一个用于API负载测试和批处理作业的简单工具。![star > 100][Bronze]
* [bombardier](https://github.com/codesenberg/bombardier) - **Star : 1674** **最近提交 : 2019-03-25**  快速跨平台 HTTP 基准测试工具。![star > 1000][Silver]
* [bosun](https://github.com/bosun-monitor/bosun) - **Star : 2841** **最近提交 : 2019-06-24**  按照时间轴发出告警的框架。![star > 1000][Silver]
...
* [dogo](https://github.com/liudng/dogo) - **Star : 215** **最近提交 : 2019-03-15**  监视源文件中的更改并自动编译和运行(restart)。![star > 100][Bronze]
...
* [fac](https://github.com/mkchoi212/fac) - **Star : 1584** **最近提交 : 2019-05-24**  修复 git 合并冲突。![star > 1000][Silver]
* [gaia](https://github.com/gaia-pipeline/gaia) - **Star : 3686** **最近提交 : 2019-07-01**  可用于任何编程语言来构建强大的管道。![star > 1000][Silver]
* [Gitea](https://github.com/go-gitea/gitea) - **Star : 14560** **最近提交 : 2019-07-01**  从 Gogs fork，完全由社区驱动。![star > 5000][Gold]
...
* [go-selfupdate](https://github.com/sanbornm/go-selfupdate) - **Star : 658** **最近提交 : 2019-03-30**  允许你的 Go应用程序 进行自我更新。![star > 100][Bronze]
* [gobrew](https://github.com/cryptojuice/gobrew) - **Star : 175** **最近提交 : 2017-04-18**  gobrew 允许您轻松地在 go 的多个版本之间切换。![star > 100][Bronze]
* [godbg](https://github.com/sirnewton01/godbg) - **Star : 219** **最近提交 : 2018-07-09**  基于 web 的 gdb 前端应用程序。![star > 100][Bronze]
* [Gogs](https://gogs.io/) - 自托管的Git服务。
* [gonative](https://github.com/inconshreveable/gonative) - **Star : 312** **最近提交 : 2016-07-22**  用原生 Go 创建一个跨平台的 Go 工具链。![star > 100][Bronze]
* [govvv](https://github.com/ahmetalpbalkan/govvv) - **Star : 372** **最近提交 : 2018-04-10**  可轻松地添加版本信息到 Go 二进制文件。![star > 100][Bronze]
* [gox](https://github.com/mitchellh/gox) - **Star : 3321** **最近提交 : 2019-05-10**  非常简单，没有多余的跨平台编译工具。![star > 1000][Silver]
* [goxc](https://github.com/laher/goxc) - **Star : 1627** **最近提交 : 2018-06-17**  专注于跨平台编译和打包的 Go 构建工具。![star > 1000][Silver]
* [grapes](https://github.com/yaronsumel/grapes) - **Star : 133** **最近提交 : 2019-04-25**  旨在轻松地通过ssh分发命令的轻量级工具。![star > 100][Bronze]
* [GVM](https://github.com/moovweb/gvm) - **Star : 4405** **最近提交 : 2019-01-01**  GVM 提供了一个接口来管理 Go 版本。![star > 1000][Silver]
* [Hey](https://github.com/rakyll/hey) - **Star : 6046** **最近提交 : 2019-06-24**  压力测试工具，可用来代替 ApacheBench (ab)。![star > 5000][Gold]
* [kala](https://github.com/ajvb/kala) - **Star : 1345** **最近提交 : 2019-06-03**  简单、现代和高性能的作业调度程序。![star > 1000][Silver]
* [kcli](https://github.com/cswank/kcli) - **Star : 65** **最近提交 : 2019-03-12**  用于检查kafka主题/分区/消息的命令行工具。
* [kubernetes](https://github.com/kubernetes/kubernetes) - **Star : 54655** **最近提交 : 2019-07-01**  来自谷歌的容器集群管理器。![star > 5000][Gold]
* [lstags](https://github.com/ivanilves/lstags) - **Star : 219** **最近提交 : 2019-06-29**  提供了工具和API，可用来同步不同注册中心的Docker图像。![star > 100][Bronze]
* [lwc](https://github.com/timdp/lwc) - **Star : 8** **最近提交 : 2018-07-01**  UNIX wc命令的实时更新版本。
* [manssh](https://github.com/xwjdsh/manssh) - **Star : 202** **最近提交 : 2018-06-22**  manssh是一个命令行工具，可以方便地管理ssh别名配置。![star > 100][Bronze]
* [Moby](https://github.com/moby/moby) - **Star : 53932** **最近提交 : 2019-06-30**  Collaborative project for the container ecosystem to assemble container-based systems.![star > 5000][Gold]
* [Mora](https://github.com/emicklei/mora) - **Star : 263** **最近提交 : 2017-01-10**  用于访问 MongoDB 文档和元数据的 REST 服务器。![star > 100][Bronze]
* [ostent](https://github.com/ostrost/ostent) - **Star : 164** **最近提交 : 2018-04-04**  收集和显示系统指标，并可选 Graphite and/or fluxdb作为依赖。![star > 100][Bronze]
* [Packer](https://github.com/mitchellh/packer) - **Star : 9065** **最近提交 : 2019-07-02**  用于从一个源配置为多个平台创建相同的机器图像。![star > 5000][Gold]
* [Pewpew](https://github.com/bengadbois/pewpew) - **Star : 199** **最近提交 : 2018-10-27**  灵活的 HTTP 命令行压测工具。![star > 100][Bronze]
* [Pomerium](https://github.com/pomerium/pomerium) - **Star : 463** **最近提交 : 2019-07-01**  Pomerium是一个可识别身份的访问代理。![star > 100][Bronze]
* [Rodent](https://github.com/alouche/rodent) - **Star : 30** **最近提交 : 2017-04-22**  管理Go版本、项目和跟踪依赖项。
* [s3gof3r](https://github.com/rlmcpherson/s3gof3r) - **Star : 988** **最近提交 : 2018-12-31**  小型实用程序/库，针对大型对象在Amazon S3中的高速传输进行了优化。![star > 100][Bronze]
* [Scaleway-cli](https://github.com/scaleway/scaleway-cli) - **Star : 533** **最近提交 : 2019-05-15**  从命令行管理 BareMetal 服务器(与使用Docker一样容易)。![star > 100][Bronze]
* [script](https://github.com/bitfield/script) - **Star : 625** **最近提交 : 2019-06-29**  让DevOps编写类shell和系统管理任务变得更加容易。![star > 100][Bronze]
* [sg](https://github.com/ChristopherRabotin/sg) - **Star : 5** **最近提交 : 2016-10-29**  可测试一组HTTP极限(如ab)，可以在每个调用之间使用响应代码和数据，根据之前的响应来确定特定的服务器压力。
* [skm](https://github.com/TimothyYe/skm) - **Star : 544** **最近提交 : 2019-05-27**  SKM是一个简单而强大的SSH密钥管理器，它可以帮助您轻松地管理多个SSH密钥!![star > 100][Bronze]
* [StatusOK](https://github.com/sanathp/statusok) - **Star : 1141** **最近提交 : 2019-06-10**  监视您的网站和REST api。当服务器宕机或响应时间超过预期时，通过Slack、电子邮件获得通知。![star > 1000][Silver]
* [traefik](https://github.com/containous/traefik) - **Star : 23125** **最近提交 : 2019-07-01**  反向代理和负载均衡器，支持多个后端。![star > 5000][Gold]
* [Vegeta](https://github.com/tsenart/vegeta) - **Star : 11860** **最近提交 : 2019-06-29**  HTTP负载测试工具和库。超过9000 !![star > 5000][Gold]
* [webhook](https://github.com/adnanh/webhook) - **Star : 3982** **最近提交 : 2019-07-01**  允许用户创建在服务器上执行命令的 HTTP hooks。![star > 1000][Silver]
...
* [borg](https://github.com/crufter/borg) - **Star : 1416** **最近提交 : 2018-02-08**  基于终端的bash代码段搜索引擎。![star > 1000][Silver]
* [boxed](https://github.com/tejo/boxed) - **Star : 72** **最近提交 : 2018-08-10**  基于Dropbox的博客引擎。
* [Cherry](https://github.com/rafael-santiago/cherry) - **Star : 192** **最近提交 : 2017-06-24**  微型网络聊天服务器。![star > 100][Bronze]
* [Circuit](https://github.com/gocircuit/circuit) - **Star : 1775** **最近提交 : 2019-05-17**  Circuit 是一个可编程平台即服务(PaaS)和/或基础设施即服务(IaaS)，用于管理、发现、同步和编排包含云应用程序的服务和主机。![star > 1000][Silver]
* [Comcast](https://github.com/tylertreat/Comcast) - **Star : 6122** **最近提交 : 2019-06-30**  模拟坏的网络连接。![star > 5000][Gold]
* [confd](https://github.com/kelseyhightower/confd) - **Star : 6309** **最近提交 : 2019-06-14**  使用 etcd 或 consul 的模板和数据管理本地应用程序配置文件。![star > 5000][Gold]
...
* [Documize](https://github.com/documize/community) - **Star : 786** **最近提交 : 2019-06-29**  集成了SaaS工具数据的现代wiki软件。![star > 100][Bronze]
* [drive](https://github.com/odeke-em/drive) - **Star : 4909** **最近提交 : 2019-06-20**  基于命令行的谷歌驱动器客户端。![star > 1000][Silver]
* [Duplicacy](https://github.com/gilbertchen/duplicacy) - **Star : 2659** **最近提交 : 2019-06-28**  跨平台网络和云备份工具。![star > 1000][Silver]
* [gfile](https://github.com/Antonito/gfile) - **Star : 486** **最近提交 : 2019-04-13**  通过WebRTC在两台计算机之间安全地传输文件，不需要任何第三方依赖。![star > 100][Bronze]
* [Go Package Store](https://github.com/shurcooL/Go-Package-Store) - **Star : 879** **最近提交 : 2018-12-17**  App that displays updates for the Go packages in your GOPATH.![star > 100][Bronze]
* [go-peerflix](https://github.com/Sioro-Neoku/go-peerflix) - **Star : 373** **最近提交 : 2019-02-23**  视频流 torrent 客户端。![star > 100][Bronze]
* [GoBoy](https://github.com/Humpheh/goboy) - **Star : 2092** **最近提交 : 2019-06-11**  用 Go 编写的任天堂Game Boy彩色模拟器。![star > 1000][Silver]
* [gocc](https://github.com/goccmack/gocc) - **Star : 336** **最近提交 : 2019-06-24**  Gocc是一个用Go编写的编译器工具包。![star > 100][Bronze]
* [GoDNS](https://github.com/timothyye/godns) - **Star : 417** **最近提交 : 2019-05-24**  一个动态DNS客户端工具，支持DNSPod & HE.net。![star > 100][Bronze]
...
* [Gor](https://github.com/buger/gor) - **Star : 11190** **最近提交 : 2019-07-01**  Http 流量复制工具，用于实时回放从生产环境到阶段/开发环境的流量。![star > 5000][Gold]
* [hugo](http://gohugo.io/) - 快速、现代的静态网站引擎。
* [ide](https://github.com/thestrukture/ide) - **Star : 249** **最近提交 : 2019-05-27**  基于浏览器的IDE![star > 100][Bronze]
* [ipe](https://github.com/dimiro1/ipe) - **Star : 274** **最近提交 : 2018-12-19**  Open source Pusher server implementation compatible with Pusher client libraries written in GO.![star > 100][Bronze]
* [joincap](https://github.com/assafmo/joincap) - **Star : 121** **最近提交 : 2019-05-06**  用于合并多个pcap文件的命令行实用程序。![star > 100][Bronze]
* [Juju](https://jujucharms.com/) - Cloud-agnostic的服务部署和编制 —— 支持EC2、Azure、Openstack、MAAS等。
* [Leaps](https://github.com/jeffail/leaps) - **Star : 641** **最近提交 : 2019-03-03**  使用操作转换的成对编程服务。![star > 100][Bronze]
* [lgo](https://github.com/yunabe/lgo) - **Star : 1765** **最近提交 : 2019-03-22**  与 Jupyter 可进行交互 Go 程序。它支持代码完成、代码检查以及与Go 100% 兼容性。![star > 1000][Silver]
* [limetext](http://limetext.org/) - 一个强大而优雅的文本编辑器。
* [LiteIDE](https://github.com/visualfc/liteide) - **Star : 5408** **最近提交 : 2019-06-23**  简单的、开源的、跨平台的Go IDE。![star > 5000][Gold]
* [mockingjay](https://github.com/quii/mockingjay-server) - **Star : 407** **最近提交 : 2019-06-18**  一份配置文件中便可伪造HTTP服务器与用户之间的行为。您还可以使服务器随机宕机，以帮助进行更实际的性能测试。![star > 100][Bronze]
* [myLG](https://github.com/mehrdadrad/mylg) - **Star : 2183** **最近提交 : 2018-10-29**  命令行网络诊断工具。![star > 1000][Silver]
* [naclpipe](https://github.com/unix4fun/naclpipe) - **Star : 20** **最近提交 : 2018-11-18**  基于加密管的简单的NaCL EC25519工具。
* [nes](https://github.com/fogleman/nes) - **Star : 4097** **最近提交 : 2019-06-17**  任天堂娱乐系统(NES)模拟器。![star > 1000][Silver]
* [orange-cat](https://github.com/noraesae/orange-cat) - **Star : 178** **最近提交 : 2019-01-14**  用Go编写的Markdown预览器。![star > 100][Bronze]
* [Orbit](https://github.com/gulien/orbit) - **Star : 128** **最近提交 : 2018-06-17**  一个根据模板来运行命令和生成文件的简单小工具。![star > 100][Bronze]
* [peg](https://github.com/pointlander/peg) - **Star : 588** **最近提交 : 2019-06-21**  解析表达式语法，是Packrat解析器生成器的实现。![star > 100][Bronze]
* [Pipe](https://github.com/b3log/pipe) - **Star : 2598** **最近提交 : 2019-06-24**  一个小巧漂亮的博客平台。![star > 1000][Silver]
* [restic](https://github.com/restic/restic) - **Star : 7188** **最近提交 : 2019-07-01**  消除重复项备份程序。![star > 5000][Gold]
* [rkt](https://github.com/coreos/rkt) - **Star : 8698** **最近提交 : 2019-07-02**  一个应用容器，与其他容器格式(如Docker)兼容，并支持其他执行引擎(如KVM)。![star > 5000][Gold]
* [scc](https://github.com/boyter/scc) - **Star : 761** **最近提交 : 2019-07-01**  一个非常快速准确的代码计数器，采用了复杂的计算和 COCOMO 预估。![star > 100][Bronze]
* [Seaweed File System](https://github.com/chrislusf/seaweedfs) - **Star : 8025** **最近提交 : 2019-07-01**  快速、简单、可伸缩的分布式文件系统，采用了O(1)磁盘查找。![star > 5000][Gold]
* [shell2http](https://github.com/msoap/shell2http) - **Star : 396** **最近提交 : 2019-03-02**  通过http服务器执行shell命令(用于原型或远程控制)。![star > 100][Bronze]
* [snap](https://github.com/intelsdi-x/snap) - **Star : 1801** **最近提交 : 2018-12-20**  强大的遥测框架。![star > 1000][Silver]
* [Snitch](https://github.com/lucasgomide/snitch) - **Star : 15** **最近提交 : 2018-07-24**  当有人通过 Tsuru 部署任何应用程序时，会通知您的团队以及其他工具。
* [Stack Up](https://github.com/pressly/sup) - **Star : 1968** **最近提交 : 2019-05-22**  Stack Up 是一个超级简单的部署工具 — 只面向Unix。![star > 1000][Silver]
...
* [toxiproxy](https://github.com/shopify/toxiproxy) - **Star : 3772** **最近提交 : 2019-06-26**  为自动化测试模拟网络和系统条件的代理。![star > 1000][Silver]
* [tsuru](https://tsuru.io/) - Extensible and open source Platform as a Service software.
* [vFlow](https://github.com/VerizonDigital/vflow) - **Star : 586** **最近提交 : 2019-06-20**  高性能、可伸缩和可靠的 IPFIX、sFlow和 Netflow 收集器。![star > 100][Bronze]
* [wellington](https://github.com/wellington/wellington) - **Star : 288** **最近提交 : 2018-10-28**  Sass 项目管理工具，使用sprite函数(如Compass)扩展语言。![star > 100][Bronze]
...
* [go-benchmarks](https://github.com/tylertreat/go-benchmarks) - **Star : 119** **最近提交 : 2016-02-25**  Few miscellaneous Go microbenchmarks. Compare some language features to alternative approaches![star > 100][Bronze]
* [go-http-routing-benchmark](https://github.com/julienschmidt/go-http-routing-benchmark) - **Star : 1253** **最近提交 : 2019-03-07**  HTTP请求路由器基准测试和比较。![star > 1000][Silver]
* [go-web-framework-benchmark](https://github.com/smallnest/go-web-framework-benchmark) - **Star : 974** **最近提交 : 2019-03-31**  web框架基准测试。![star > 100][Bronze]
* [go_serialization_benchmarks](https://github.com/alecthomas/go_serialization_benchmarks) - **Star : 841** **最近提交 : 2019-04-17**  Go序列化方法的基准测试。![star > 100][Bronze]
...
* [skynet](https://github.com/atemerev/skynet) - **Star : 908** **最近提交 : 2019-05-12**  天网 1M 线程微基准测试。![star > 100][Bronze]
* [speedtest-resize](https://github.com/fawick/speedtest-resize) - **Star : 172** **最近提交 : 2017-03-14**  对比各种图像大小调整算法性能。![star > 100][Bronze]
...
* [GoBooks](https://github.com/dariubs/GoBooks) - **Star : 6668** **最近提交 : 2019-05-30**  一份精选的 Go 书籍清单。![star > 5000][Gold]
...
* [Free Gophers Pack](https://github.com/MariaLetta/free-gophers-pack) - **Star : 1457** **最近提交 : 2019-06-14**  由 Maria Letta 提供的与 Gopher 有关的图片包，其中包含了插图,表情文字。![star > 1000][Silver]
...
* [gopherize.me](https://github.com/matryer/gopherize.me) - **Star : 312** **最近提交 : 2018-10-21**  Gopherize自己。![star > 100][Bronze]
* [gophers](https://github.com/ashleymcnamara/gophers) - **Star : 1809** **最近提交 : 2019-04-13**  阿什莉·麦克纳马拉的歌斐艺术品。![star > 1000][Silver]
* [gophers](https://github.com/egonelbre/gophers) - **Star : 1546** **最近提交 : 2019-03-18**  Free gophers.![star > 1000][Silver]
...
* [Awesome Remote Job](https://github.com/lukasz-madon/awesome-remote-job) - **Star : 14363** **最近提交 : 2019-06-30**  Curated list of awesome remote jobs. A lot of them are looking for Go hackers.![star > 5000][Gold]
* [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) - **Star : 24467** **最近提交 : 2019-06-26**  其他 awesome 系列的列表。![star > 5000][Gold]
...
* [golang-graphics](https://github.com/mholt/golang-graphics) - **Star : 141** **最近提交 : 2015-08-25**  收藏的 Go 图像，图形和艺术作品。![star > 100][Bronze]
...
* [Build web application with Golang](https://github.com/astaxie/build-web-application-with-golang) - **Star : 30904** **最近提交 : 2019-06-24**  Golang电子书，主要讲述如何用 Golang 建立一个web应用程序。![star > 5000][Gold]
...
* [Ethereum Development with Go](https://github.com/miguelmota/ethereum-development-with-go-book) - **Star : 436** **最近提交 : 2019-06-17**  一本讲述如何用 Go 进行以太开发的小册。![star > 100][Bronze]
* [Games With Go](http://gameswithgo.org/) - 关于编程和游戏开发系列教学视频。
* [Go By Example](https://gobyexample.com/) - 手把手教你 如何在 Go 应用程序中使用注释。
* [Go Cheat Sheet](https://github.com/a8m/go-lang-cheat-sheet) - **Star : 3968** **最近提交 : 2019-02-18**   Go's reference card。![star > 1000][Silver]
...
* [Golang for Node.js Developers](https://github.com/miguelmota/golang-for-nodejs-developers) - **Star : 661** **最近提交 : 2019-06-02**  引入示例讲述 Golang 与Node.js在学习上的差异。![star > 100][Bronze]
...
* [Learn Go with TDD](https://github.com/quii/learn-go-with-tests) - **Star : 3840** **最近提交 : 2019-06-26**  学习使用测试驱动开发。![star > 1000][Silver]
* [package main](https://www.youtube.com/packagemain) - 关于 Go 编程的YouTube频道。
* [The world’s easiest introduction to WebAssembly with Golang](https://medium.com/@martinolsansky/webassembly-with-golang-is-fun-b243c0e34f02)
* [Working with Go](https://github.com/mkaz/working-with-go) - **Star : 1127** **最近提交 : 2019-06-11**  由一个经验丰富的Go程序员群体编写的一系列Go学习范例。![star > 1000][Silver]
